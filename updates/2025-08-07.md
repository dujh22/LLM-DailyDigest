...
## [#8](https://arxiv.org/abs/2508.04428) [\textsc{SimInstruct}: A Responsible Tool for Collecting Scaffolding Dialogues Between Experts and LLM-Simulated Novices](https://papers.cool/arxiv/2508.04428)  #8 \textsc{SimInstruct}：一个用于收集专家与 LLM 模拟新手之间支架对话的负责任工具 
