...
**Authors**: [Michael Katz](https://arxiv.org/search/?searchtype=author&query=Michael Katz), [Harsha Kokel](https://arxiv.org/search/?searchtype=author&query=Harsha Kokel), [Sarath Sreedharan](https://arxiv.org/search/?searchtype=author&query=Sarath Sreedharan)
...
**Publish**: 2025-08-04 21:01:03 UTC
...
## [#63](https://arxiv.org/abs/2508.03613) [Goedel-Prover-V2: Scaling Formal Theorem Proving with Scaffolded Data Synthesis and Self-Correction](https://papers.cool/arxiv/2508.03613)  #63 Goedel-Prover-V2：通过分阶段数据合成与自我纠正扩展形式定理证明

**Authors**: [Yong Lin](https://arxiv.org/search/?searchtype=author&query=Yong Lin), [Shange Tang](https://arxiv.org/search/?searchtype=author&query=Shange Tang), [Bohan Lyu](https://arxiv.org/search/?searchtype=author&query=Bohan Lyu), [Ziran Yang](https://arxiv.org/search/?searchtype=author&query=Ziran Yang), [Jui-Hui Chung](https://arxiv.org/search/?searchtype=author&query=Jui-Hui Chung), [Haoyu Zhao](https://arxiv.org/search/?searchtype=author&query=Haoyu Zhao), [Lai Jiang](https://arxiv.org/search/?searchtype=author&query=Lai Jiang), [Yihan Geng](https://arxiv.org/search/?searchtype=author&query=Yihan Geng), [Jiawei Ge](https://arxiv.org/search/?searchtype=author&query=Jiawei Ge), [Jingruo Sun](https://arxiv.org/search/?searchtype=author&query=Jingruo Sun), [Jiayun Wu](https://arxiv.org/search/?searchtype=author&query=Jiayun Wu), [Jiri Gesi](https://arxiv.org/search/?searchtype=author&query=Jiri Gesi), [Ximing Lu](https://arxiv.org/search/?searchtype=author&query=Ximing Lu), [David Acuna](https://arxiv.org/search/?searchtype=author&query=David Acuna), [Kaiyu Yang](https://arxiv.org/search/?searchtype=author&query=Kaiyu Yang), [Hongzhou Lin](https://arxiv.org/search/?searchtype=author&query=Hongzhou Lin), [Yejin Choi](https://arxiv.org/search/?searchtype=author&query=Yejin Choi), [Danqi Chen](https://arxiv.org/search/?searchtype=author&query=Danqi Chen), [Sanjeev Arora](https://arxiv.org/search/?searchtype=author&query=Sanjeev Arora), [Chi Jin](https://arxiv.org/search/?searchtype=author&query=Chi Jin)
...
**Publish**: 2025-08-05 16:28:22 UTC
...
**Authors**: [Yicheng Feng](https://arxiv.org/search/?searchtype=author&query=Yicheng Feng), [Xin Tan](https://arxiv.org/search/?searchtype=author&query=Xin Tan), [Kin Hang Sew](https://arxiv.org/search/?searchtype=author&query=Kin Hang Sew), [Yimin Jiang](https://arxiv.org/search/?searchtype=author&query=Yimin Jiang), [Yibo Zhu](https://arxiv.org/search/?searchtype=author&query=Yibo Zhu), [Hong Xu](https://arxiv.org/search/?searchtype=author&query=Hong Xu)
作者：冯一成，谭鑫，徐建恒，姜一民，朱一博，徐宏
...
**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Distributed, Parallel, and Cluster Computing](https://papers.cool/arxiv/cs.DC)
主题：机器学习，人工智能，分布式、并行与集群计算

**Publish**: 2025-08-05 06:53:28 UTC
...
**Authors**: [Long S. T. Nguyen](https://arxiv.org/search/?searchtype=author&query=Long S. T. Nguyen), [Khang H. N. Vo](https://arxiv.org/search/?searchtype=author&query=Khang H. N. Vo), [Thu H. A. Nguyen](https://arxiv.org/search/?searchtype=author&query=Thu H. A. Nguyen), [Tuan C. Bui](https://arxiv.org/search/?searchtype=author&query=Tuan C. Bui), [Duc Q. Nguyen](https://arxiv.org/search/?searchtype=author&query=Duc Q. Nguyen), [Thanh-Tung Tran](https://arxiv.org/search/?searchtype=author&query=Thanh-Tung Tran), [Anh D. Nguyen](https://arxiv.org/search/?searchtype=author&query=Anh D. Nguyen), [Minh L. Nguyen](https://arxiv.org/search/?searchtype=author&query=Minh L. Nguyen), [Fabien Baldacci](https://arxiv.org/search/?searchtype=author&query=Fabien Baldacci), [Thang H. Bui](https://arxiv.org/search/?searchtype=author&query=Thang H. Bui), [Emanuel Di Nardo](https://arxiv.org/search/?searchtype=author&query=Emanuel Di Nardo), [Angelo Ciaramella](https://arxiv.org/search/?searchtype=author&query=Angelo Ciaramella), [Son H. Le](https://arxiv.org/search/?searchtype=author&query=Son H. Le), [Ihsan Ullah](https://arxiv.org/search/?searchtype=author&query=Ihsan Ullah), [Lorenzo Di Rocco](https://arxiv.org/search/?searchtype=author&query=Lorenzo Di Rocco), [Tho T. Quan](https://arxiv.org/search/?searchtype=author&query=Tho T. Quan)
...
2. 区别推理和规划能力
3. 递归自我改进（RSI）
4. OpenAI正在通过一种名为「Universal Verifier」的技术，让GPT-5在全领域实现稳步提升。翻译过来就是：通用验证器。这项技术的核心思想是：让一个AI 模型充当「验证者」，检查另一个模型的输出质量。
