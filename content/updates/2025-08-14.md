...
title = "Google 发布 Gemma 3 270M 超紧凑模型"
subtopic = "轻量化模型"
topics = [
    "模型开发",
    "系统优化",
...
summary = "Google 推出 Gemma 3 270M，以紧凑架构、低能耗、指令遵循能力和生产级量化支持满足端侧及任务专用部署需求。"
paper = ""
code = ""
dataset = ""
link = "https://developers.googleblog.com/en/introducing-gemma-3-270m/"
content = "Google 发布仅有 2.7 亿参数的 Gemma 3 270M，面向资源受限环境和任务专用型应用。该模型采用紧凑高效的架构，重点降低推理所需的计算资源与能源消耗。它具备指令遵循能力，可通过微调适配文本分类、信息抽取等明确任务。官方还提供面向生产部署的量化支持，便于在端侧设备或低成本基础设施上运行。"
purpose = "- 适合构建低延迟、低成本、注重隐私的端侧 AI 应用\n- 可作为任务专用模型的微调底座，减少对大型通用模型的依赖\n- 量化支持有助于降低内存占用和能耗，推动小模型进入生产环境"
notes = "3. 新模型的核心功能可概括为以下4部分：\n   1. 紧凑且高效的架构\n   2. 极致的能源效率\n   3. 指令遵循\n   4. 可用于生产的量化支持\n   5. [https://developers.googleblog.com/en/introducing-gemma-3-270m/](https://developers.googleblog.com/en/introducing-gemma-3-270m/)"
...
**Publish**: 2025-08-13 13:39:17 UTC
...
**Publish**: 2025-08-13 08:53:17 UTC
...
**Publish**: 2025-08-13 05:55:59 UTC
...
**Publish**: 2025-08-13 05:55:48 UTC
发布：2025-08-13 05:55:48 UTC

## [#33](https://arxiv.org/abs/2508.09497) [From Ranking to Selection: A Simple but Efficient Dynamic Passage Selector for Retrieval Augmented Generation 从排序到选择：一种简单而高效的用于检索增强生成的动态段落选择器](https://papers.cool/arxiv/2508.09497)

**Authors**: [Siyuan Meng](https://arxiv.org/search/?searchtype=author&query=Siyuan Meng), [Junming Liu](https://arxiv.org/search/?searchtype=author&query=Junming Liu), [Yirong Chen](https://arxiv.org/search/?searchtype=author&query=Yirong Chen), [Song Mao](https://arxiv.org/search/?searchtype=author&query=Song Mao), [Pinlong Cai](https://arxiv.org/search/?searchtype=author&query=Pinlong Cai), [Guohang Yan](https://arxiv.org/search/?searchtype=author&query=Guohang Yan), [Botian Shi](https://arxiv.org/search/?searchtype=author&query=Botian Shi), [Ding Wang](https://arxiv.org/search/?searchtype=author&query=Ding Wang)
...
**Publish**: 2025-08-13 05:05:34 UTC
发布时间：2025-08-13 05:05:34 UTC

## [#34](https://arxiv.org/abs/2508.09494) [Learning Facts at Scale with Active Reading 通过主动阅读在大规模上学习事实](https://papers.cool/arxiv/2508.09494)
...
**Publish**: 2025-08-13 04:54:43 UTC
发布：2025-08-13 04:54:43 UTC

## [#35](https://arxiv.org/abs/2508.09463) [User-centric Subjective Leaderboard by Customizable Reward Modeling 通过可定制奖励建模实现以用户为中心的主观排行榜](https://papers.cool/arxiv/2508.09463)
...
**Publish**: 2025-08-13 03:39:04 UTC
发布时间：2025-08-13 03:39:04 UTC

## [#36](https://arxiv.org/abs/2508.09450) [From Charts to Fair Narratives: Uncovering and Mitigating Geo-Economic Biases in Chart-to-Text 从图表到公平叙述：揭示并缓解图表转文本中的地缘经济偏见](https://papers.cool/arxiv/2508.09450)
...
**Publish**: 2025-08-13 03:09:00 UTC
发布：2025-08-13 03:09:00 UTC

## [#37](https://arxiv.org/abs/2508.09430) [Leveraging Zipformer Model for Effective Language Identification in Code-Switched Child-Directed Speech 在面向儿童的对话中利用 Zipformer 模型进行有效的语言识别](https://papers.cool/arxiv/2508.09430)
...
在以儿童为对象的场景中，代码切换和语言识别带来了显著挑战，尤其是在双语环境中。本文通过使用 Zipformer 来处理包含普通话和英语两种不平衡语言的语句中的语音细微差异，以应对这一挑战。研究表明，Zipformer 的内部层有效地编码了语言特征，可用于语言识别。我们提出了从内部层选择并提取嵌入表示的方法，并与不同的后端进行比较。分析表明 Zipformer 在这些后端上都具有鲁棒性。我们的方法有效处理了不平衡数据，取得了 81.89% 的平衡准确率（BAC），比语言识别基线提升了 15.47%。这些发现强调了基于 Transformer 编码器架构模型在实际场景中的潜力。

**Subjects**: [Computation and Language](https://papers.cool/arxiv/cs.CL), [Sound](https://papers.cool/arxiv/cs.SD)
主题：计算与语言，声音

**Publish**: 2025-08-13 02:10:31 UTC
发布：2025-08-13 02:10:31 UTC

## [#38](https://arxiv.org/abs/2508.09403) [Columbo: Expanding Abbreviated Column Names for Tabular Data Using Large Language Models Columbo：使用大型语言模型为表格数据扩展缩写列名](https://papers.cool/arxiv/2508.09403)
...
**Subjects**: [Computation and Language](https://papers.cool/arxiv/cs.CL), [Databases](https://papers.cool/arxiv/cs.DB)
主题：计算与语言，数据库

**Publish**: 2025-08-13 00:39:22 UTC
发布：2025-08-13 00:39:22 UTC

## [#39](https://arxiv.org/abs/2508.09378) [APIO: Automatic Prompt Induction and Optimization for Grammatical Error Correction and Text Simplification APIO：用于语法错误纠正与文本简化的自动提示归纳与优化](https://papers.cool/arxiv/2508.09378)
...
近年来，大型语言模型（LLMs）的进步使得通过简单的基于提示的交互即可执行广泛的自然语言处理（NLP）任务成为可能。因此，已经提出了若干方法来设计提示，以最有效地让 LLMs 执行特定任务（例如，链式思维提示）。在存在明确定义的度量以优化模型性能的场景中，自动提示优化（APO）方法已被开发用于改进种子提示。推进这条研究路线，我们提出了 APIO，一种用于语法错误纠正（GEC）和文本简化任务的简单但有效的提示归纳与优化方法，无需依赖人工指定的种子提示。APIO 在这些任务上为纯基于 LLM 的提示方法达到了新的最先进性能。我们已将数据、代码、提示和输出公开可用。

**Subjects**: [Computation and Language](https://papers.cool/arxiv/cs.CL), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：计算与语言，人工智能

**Publish**: 2025-08-12 22:26:32 UTC
发布：2025-08-12 22:26:32 UTC

## [#40](https://arxiv.org/abs/2508.09350) [Flow-SLM: Joint Learning of Linguistic and Acoustic Information for Spoken Language Modeling Flow-SLM：用于说话语言建模的语言与声学信息联合学习](https://papers.cool/arxiv/2508.09350)
...
无文本的语音语言模型（SLMs）是指不依赖文本监督的语音生成模型。大多数无文本 SLMs 通过预测下一个语义令牌（一种离散的语言内容表示）来学习，并依赖单独的声码器为生成的语音添加声学信息。此类模型无法获得声学上下文，也无法对声学细节进行内置控制。在这项工作中，我们提出通过生成语义令牌和声学帧的连续实值表示来联合建模语言信息和声学信息。我们使用流匹配（flow-matching）目标来在给定语义令牌的条件下预测该连续向量。我们研究了该方法的设计空间，发现预测多个未来语义令牌有助于保留语言信息。在语言可能性基准方面，我们的方法在性能上与现有模型相当，同时在提示生成中提供了更好的声学细节。

**Subject**: [Computation and Language](https://papers.cool/arxiv/cs.CL)
主题：Computation and Language

**Publish**: 2025-08-12 21:25:37 UTC
发布：2025-08-12 21:25:37 协调世界时

## [#41](https://arxiv.org/abs/2508.09349) [The Human-AI Hybrid Delphi Model: A Structured Framework for Context-Rich, Expert Consensus in Complex Domains 人类—人工智能混合德尔菲模型：一种用于复杂领域具备丰富情境的专家共识的结构化框架](https://papers.cool/arxiv/2508.09349)
...
**Publish**: 2025-08-12 21:24:19 UTC
发布：2025-08-12 21:24:19 协调世界时 (UTC)

## [#42](https://arxiv.org/abs/2508.09337) [Decoding Neural Emotion Patterns through Natural Language Processing Embeddings 通过自然语言处理嵌入解读神经情感模式](https://papers.cool/arxiv/2508.09337)
...
**Publish**: 2025-08-12 20:51:56 UTC
发表：2025-08-12 20:51:56 UTC

## [#43](https://arxiv.org/abs/2508.09324) [TEN: Table Explicitization, Neurosymbolically TEN：表格显式化，神经符号化](https://papers.cool/arxiv/2508.09324)
...
**Publish**: 2025-08-12 20:16:41 UTC
发布：2025-08-12 20:16:41 UTC

## [#44](https://arxiv.org/abs/2508.09323) [Leveraging Large Language Models for Rare Disease Named Entity Recognition 利用大型语言模型进行罕见病命名实体识别](https://papers.cool/arxiv/2508.09323)
...
**Publish**: 2025-08-12 20:16:31 UTC
发布：2025-08-12 20:16:31 UTC

## [#45](https://arxiv.org/abs/2508.09303) [ParallelSearch: Train your LLMs to Decompose Query and Search Sub-queries in Parallel with Reinforcement Learning ParallelSearch：使用强化学习训练你的 LLMs 将查询分解并并行搜索子查询](https://papers.cool/arxiv/2508.09303)  #45ParallelSearch：使用强化学习训练你的 LLMs 将查询分解并并行搜索子查询 ParallelSearch：使用强化学习训练你的 LLMs 将查询分解并并行搜索子查询[PDF 3 ] [Copy] [Kimi 1 ] [REL]

**Authors**: [Shu Zhao](https://arxiv.org/search/?searchtype=author&query=Shu Zhao), [Tan Yu](https://arxiv.org/search/?searchtype=author&query=Tan Yu), [Anbang Xu](https://arxiv.org/search/?searchtype=author&query=Anbang Xu), [Japinder Singh](https://arxiv.org/search/?searchtype=author&query=Japinder Singh), [Aaditya Shukla](https://arxiv.org/search/?searchtype=author&query=Aaditya Shukla), [Rama Akkiraju](https://arxiv.org/search/?searchtype=author&query=Rama Akkiraju)
...
**Publish**: 2025-08-12 19:38:21 UTC
发布：2025-08-12 19:38:21 协调世界时（UTC）

## [#46](https://arxiv.org/abs/2508.09987) [Echo-4o: Harnessing the Power of GPT-4o Synthetic Images for Improved Image Generation Echo-4o：利用 GPT-4o 合成图像的能力以改进图像生成](https://papers.cool/arxiv/2508.09987)

**Authors**: [Junyan Ye](https://arxiv.org/search/?searchtype=author&query=Junyan Ye), [Dongzhi Jiang](https://arxiv.org/search/?searchtype=author&query=Dongzhi Jiang), [Zihao Wang](https://arxiv.org/search/?searchtype=author&query=Zihao Wang), [Leqi Zhu](https://arxiv.org/search/?searchtype=author&query=Leqi Zhu), [Zhenghao Hu](https://arxiv.org/search/?searchtype=author&query=Zhenghao Hu), [Zilong Huang](https://arxiv.org/search/?searchtype=author&query=Zilong Huang), [Jun He](https://arxiv.org/search/?searchtype=author&query=Jun He), [Zhiyuan Yan](https://arxiv.org/search/?searchtype=author&query=Zhiyuan Yan), [Jinghua Yu](https://arxiv.org/search/?searchtype=author&query=Jinghua Yu), [Hongsheng Li](https://arxiv.org/search/?searchtype=author&query=Hongsheng Li), [Conghui He](https://arxiv.org/search/?searchtype=author&query=Conghui He), [Weijia Li](https://arxiv.org/search/?searchtype=author&query=Weijia Li)
...
**Publish**: 2025-08-13 17:59:28 UTC
发布：2025-08-13 17:59:28 UTC

## [#47](https://arxiv.org/abs/2508.09886) [COME: Dual Structure-Semantic Learning with Collaborative MoE for Universal Lesion Detection Across Heterogeneous Ultrasound Datasets](https://papers.cool/arxiv/2508.09886)  #47 COME：具有协同 MoE 的双重结构-语义学习，用于跨异质超声数据集的通用病灶检测 [PDF ] [Copy] [Kimi ] [REL]

**Authors**: [Lingyu Chen](https://arxiv.org/search/?searchtype=author&query=Lingyu Chen), [Yawen Zeng](https://arxiv.org/search/?searchtype=author&query=Yawen Zeng), [Yue Wang](https://arxiv.org/search/?searchtype=author&query=Yue Wang), [Peng Wan](https://arxiv.org/search/?searchtype=author&query=Peng Wan), [Guo-chen Ning](https://arxiv.org/search/?searchtype=author&query=Guo-chen Ning), [Hongen Liao](https://arxiv.org/search/?searchtype=author&query=Hongen Liao), [Daoqiang Zhang](https://arxiv.org/search/?searchtype=author&query=Daoqiang Zhang), [Fang Chen](https://arxiv.org/search/?searchtype=author&query=Fang Chen)
作者：陈凌宇、曾雅雯、王越、万鹏、宁国臣、廖洪恩、张道强、陈方
...
## [#48](https://arxiv.org/abs/2508.09651) [A Close Reading Approach to Gender Narrative Biases in AI-Generated Stories](https://papers.cool/arxiv/2508.09651)

**Authors**: [Daniel Raffini](https://arxiv.org/search/?searchtype=author&query=Daniel Raffini), [Agnese Macori](https://arxiv.org/search/?searchtype=author&query=Agnese Macori), [Marco Angelini](https://arxiv.org/search/?searchtype=author&query=Marco Angelini), [Tiziana Catarci](https://arxiv.org/search/?searchtype=author&query=Tiziana Catarci)
...
论文探讨了在 ChatGPT、Gemini 和 Claude 生成的故事中基于性别的叙事偏见研究。提示设计借鉴了普罗普（Propp）的人物分类和弗雷塔格（Freytag）的叙事结构。通过细读方法对故事进行分析，特别关注对提示的遵循性、人物的性别分布、身体与心理描述、行为，以及最后的情节发展和人物关系。结果揭示了生成故事中偏见的持续存在——尤以隐性偏见为甚——并强调了使用解释性方法在多层面评估偏见的重要性。

**Subjects**: [Human-Computer Interaction](https://papers.cool/arxiv/cs.HC), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Computation and Language](https://papers.cool/arxiv/cs.CL), [Computers and Society](https://papers.cool/arxiv/cs.CY)
主题：人机交互、人工智能、计算与语言、计算机与社会

**Publish**: 2025-08-13 09:34:37 UTC
发布：2025-08-13 09:34:37 UTC

## [#49](https://arxiv.org/abs/2508.09614) [How Persuasive Could LLMs Be? A First Study Combining Linguistic-Rhetorical Analysis and User Experiments](https://papers.cool/arxiv/2508.09614)  #49 语言模型可以有多有说服力？一项首次将语言-修辞分析与用户实验相结合的研究

**Authors**: [Daniel Raffini](https://arxiv.org/search/?searchtype=author&query=Daniel Raffini), [Agnese Macori](https://arxiv.org/search/?searchtype=author&query=Agnese Macori), [Lorenzo Porcaro](https://arxiv.org/search/?searchtype=author&query=Lorenzo Porcaro), [Tiziana Catarci](https://arxiv.org/search/?searchtype=author&query=Tiziana Catarci), [Marco Angelini](https://arxiv.org/search/?searchtype=author&query=Marco Angelini)
...
## [#50](https://arxiv.org/abs/2508.09535) [AI Blob! LLM-Driven Recontextualization of Italian Television Archives](https://papers.cool/arxiv/2508.09535)  #50 AI Blob! LLM 驱动的意大利电视档案再构境化

**Author**: [Roberto Balestri](https://arxiv.org/search/?searchtype=author&query=Roberto Balestri)
作者：Roberto Balestri
...
**Subjects**: [Multimedia](https://papers.cool/arxiv/cs.MM), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Computation and Language](https://papers.cool/arxiv/cs.CL), [Digital Libraries](https://papers.cool/arxiv/cs.DL)

**Publish**: 2025-08-13 06:38:32 UTC

## [#51](https://arxiv.org/abs/2508.09473) [NeuronTune: Fine-Grained Neuron Modulation for Balanced Safety-Utility Alignment in LLMs](https://papers.cool/arxiv/2508.09473)
...
**Publish**: 2025-08-13 04:05:28 UTC
发布：2025-08-13 04:05:28 UTC

## [#52](https://arxiv.org/abs/2508.09456) [IAG: Input-aware Backdoor Attack on VLMs for Visual Grounding](https://papers.cool/arxiv/2508.09456)  #52 IAG：面向视觉定位的视觉语言模型输入感知后门攻击

**Authors**: [Junxian Li](https://arxiv.org/search/?searchtype=author&query=Junxian Li), [Beining Xu](https://arxiv.org/search/?searchtype=author&query=Beining Xu), [Di Zhang](https://arxiv.org/search/?searchtype=author&query=Di Zhang)
作者：李俊贤、徐贝宁、张迪
...
**Subjects**: [Computer Vision and Pattern Recognition](https://papers.cool/arxiv/cs.CV), [Computation and Language](https://papers.cool/arxiv/cs.CL), [Cryptography and Security](https://papers.cool/arxiv/cs.CR)
主题：计算机视觉与模式识别，计算与语言，加密学与安全

**Publish**: 2025-08-13 03:22:19 UTC
发表：2025-08-13 03:22:19 UTC

## [#53](https://arxiv.org/abs/2508.09442) [Shadow in the Cache: Unveiling and Mitigating Privacy Risks of KV-cache in LLM Inference](https://papers.cool/arxiv/2508.09442)  #53 缓存中的阴影：揭示并缓解 LLM 推理中 KV-cache 的隐私风险

**Authors**: [Zhifan Luo](https://arxiv.org/search/?searchtype=author&query=Zhifan Luo), [Shuo Shao](https://arxiv.org/search/?searchtype=author&query=Shuo Shao), [Su Zhang](https://arxiv.org/search/?searchtype=author&query=Su Zhang), [Lijing Zhou](https://arxiv.org/search/?searchtype=author&query=Lijing Zhou), [Yuke Hu](https://arxiv.org/search/?searchtype=author&query=Yuke Hu), [Chenxu Zhao](https://arxiv.org/search/?searchtype=author&query=Chenxu Zhao), [Zhihao Liu](https://arxiv.org/search/?searchtype=author&query=Zhihao Liu), [Zhan Qin](https://arxiv.org/search/?searchtype=author&query=Zhan Qin)
作者：罗智凡、邵硕、张肃、周丽静、胡宇柯、赵晨旭、刘志豪、秦展
...
**Subjects**: [Cryptography and Security](https://papers.cool/arxiv/cs.CR), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Computation and Language](https://papers.cool/arxiv/cs.CL)
主题：密码学与安全、人工智能、计算与语言

**Publish**: 2025-08-13 02:48:25 UTC
发布：2025-08-13 02:48:25 UTC

## [#54](https://arxiv.org/abs/2508.09389) [ProMode: A Speech Prosody Model Conditioned on Acoustic and Textual Inputs](https://papers.cool/arxiv/2508.09389)  #54 ProMode：一个以声学和文本输入为条件的语音韵律模型

**Authors**: [Eray Eren](https://arxiv.org/search/?searchtype=author&query=Eray Eren), [Qingju Liu](https://arxiv.org/search/?searchtype=author&query=Qingju Liu), [Hyeongwoo Kim](https://arxiv.org/search/?searchtype=author&query=Hyeongwoo Kim), [Pablo Garrido](https://arxiv.org/search/?searchtype=author&query=Pablo Garrido), [Abeer Alwan](https://arxiv.org/search/?searchtype=author&query=Abeer Alwan)
...
**Subjects**: [Audio and Speech Processing](https://papers.cool/arxiv/eess.AS), [Computation and Language](https://papers.cool/arxiv/cs.CL), [Machine Learning](https://papers.cool/arxiv/cs.LG), [Sound](https://papers.cool/arxiv/cs.SD)
Subjects: 音频与语音处理, 计算与语言, 机器学习, 声音

**Publish**: 2025-08-12 23:12:18 UTC

## [#55](https://arxiv.org/abs/2508.09294) [Fake-Mamba: Real-Time Speech Deepfake Detection Using Bidirectional Mamba as Self-Attention&#39;s Alternative](https://papers.cool/arxiv/2508.09294)  #55 假眼镜蛇：使用双向 Mamba 作为自注意力替代的实时语音深度伪造检测

**Authors**: [Xi Xuan](https://arxiv.org/search/?searchtype=author&query=Xi Xuan), [Zimo Zhu](https://arxiv.org/search/?searchtype=author&query=Zimo Zhu), [Wenxin Zhang](https://arxiv.org/search/?searchtype=author&query=Wenxin Zhang), [Yi-Cheng Lin](https://arxiv.org/search/?searchtype=author&query=Yi-Cheng Lin), [Tomi Kinnunen](https://arxiv.org/search/?searchtype=author&query=Tomi Kinnunen)
...
语音合成的进步加剧了安全威胁，促使实时深度伪造检测研究。我们探讨双向 Mamba 是否可以作为检测合成语音时与自注意力（Self-Attention）竞争的替代方案。我们的解决方案 Fake-Mamba 将 XLSR 前端与双向 Mamba 相结合，以捕捉局部和全局伪迹。我们的核心创新提出了三种高效编码器：TransBiMamba、ConBiMamba 和 PN-BiMamba。借助 XLSR 丰富的语言表征，PN-BiMamba 能有效捕捉合成语音的细微线索。在 ASVspoof 21 LA、21 DF 和 In-The-Wild 基准上的评估中，Fake-Mamba 分别实现了 0.97%、1.74% 和 5.85% 的 EER，相较于最先进模型 XLSR-Conformer 和 XLSR-Mamba 表现出显著的相对提升。该框架在不同话语长度下均能维持实时推理，展现出强泛化能力和实际可行性。代码可在 https://github.com/xuanxixi/Fake-Mamba 获取。

**Subjects**: [Audio and Speech Processing](https://papers.cool/arxiv/eess.AS), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Computation and Language](https://papers.cool/arxiv/cs.CL), [Machine Learning](https://papers.cool/arxiv/cs.LG), [Systems and Control](https://papers.cool/arxiv/eess.SY)
主题：音频与语音处理、人工智能、计算与语言、机器学习、系统与控制

**Publish**: 2025-08-12 19:15:13 UTC
发布日期：2025-08-12 19:15:13 UTC

## [#56](https://arxiv.org/abs/2508.09288) [Can AI Keep a Secret? Contextual Integrity Verification: A Provable Security Architecture for LLMs](https://papers.cool/arxiv/2508.09288)  #56 AI 能守住秘密吗？情境完整性验证：一种面向 LLMs 的可证明安全架构
...
**Publish**: 2025-08-12 00:18:23 UTC
发表：2025-08-12 00:18:23 协调世界时

## [#59](https://arxiv.org/abs/2508.09199) [Δ-AttnMask: Attention-Guided Masked Hidden States for Efficient Data Selection and Augmentation](https://papers.cool/arxiv/2508.09199)  #59 Δ -AttnMask：用于高效数据选择与增强的注意力引导掩码隐藏状态

**Authors**: [Jucheng Hu](https://arxiv.org/search/?searchtype=author&query=Jucheng Hu), [Suorong Yang](https://arxiv.org/search/?searchtype=author&query=Suorong Yang), [Dongzhan Zhou](https://arxiv.org/search/?searchtype=author&query=Dongzhan Zhou)
作者：胡巨成、杨索荣、周东展
...
**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Computation and Language](https://papers.cool/arxiv/cs.CL), [Computer Vision and Pattern Recognition](https://papers.cool/arxiv/cs.CV)
主题：机器学习，计算与语言，计算机视觉与模式识别

**Publish**: 2025-07-31 11:50:16 UTC
发布：2025-07-31 11:50:16 UTC
...
## [#1](https://arxiv.org/abs/2508.09932) [Mathematical Computation and Reasoning Errors by Large Language Models](https://papers.cool/arxiv/2508.09932)  #1 大型语言模型在数学计算与推理中的错误

**Authors**: [Liang Zhang](https://arxiv.org/search/?searchtype=author&query=Liang Zhang), [Edith Aurora Graf](https://arxiv.org/search/?searchtype=author&query=Edith Aurora Graf)
作者：张亮，Edith Aurora Graf
...
**Publish**: 2025-08-13 16:33:02 UTC
发布：2025-08-13 16:33:02 UTC

## [#2](https://arxiv.org/abs/2508.09893) [RAGulating Compliance: A Multi-Agent Knowledge Graph for Regulatory QA](https://papers.cool/arxiv/2508.09893)  #2 RAGulating Compliance：用于监管问答的多代理知识图谱
...
**Publish**: 2025-08-13 15:51:05 UTC
发布：2025-08-13 15:51:05 UTC

## [#3](https://arxiv.org/abs/2508.09889) [AWorld: Dynamic Multi-Agent System with Stable Maneuvering for Robust GAIA Problem Solving](https://papers.cool/arxiv/2508.09889)  #3 AWorld：用于鲁棒 GAIA 问题求解的具稳定机动性的动态多智能体系统
...
**Publish**: 2025-08-13 14:52:14 UTC
发布：2025-08-13 14:52:14 UTC

## [#5](https://arxiv.org/abs/2508.09784) [Reasoning About Knowledge on Regular Expressions is 2EXPTIME-complete](https://papers.cool/arxiv/2508.09784)  #5 关于正则表达式的知识推理是 2EXPTIME 完全的

**Authors**: [Avijeet Ghosh](https://arxiv.org/search/?searchtype=author&query=Avijeet Ghosh), [Sujata Ghosh](https://arxiv.org/search/?searchtype=author&query=Sujata Ghosh), [François Schwarzentruber](https://arxiv.org/search/?searchtype=author&query=François Schwarzentruber)
...
用于推理知识与行动的逻辑在多智能体系统的诸多领域（包括认识论规划）中已有广泛应用。基于对环境的观测而产生的知识变化构成了此类规划场景中的关键方面。公共观测逻辑（Public Observation Logic，POL）是公共宣告逻辑的一个变体，用于推理基于公共观测而更新的知识。认识论（Kripke）模型中的每个状态都配备了一组预期的观测。当这些预期与实际观测相匹配时，状态会发生演化。在这项工作中，我们证明了 \POL 的可满足性问题是 2EXPTIME 完全的。
...
发布：2025-08-13 13:10:16 UTC

## [#6](https://arxiv.org/abs/2508.09762) [The PacifAIst Benchmark:Would an Artificial Intelligence Choose to Sacrifice Itself for Human Safety?](https://papers.cool/arxiv/2508.09762)  #6 PacifAIst 基准：人工智能会为人类安全选择自我牺牲吗？
...
**Publish**: 2025-08-13 11:41:01 UTC
发布：2025-08-13 11:41:01 UTC

## [#8](https://arxiv.org/abs/2508.09670) [MEML-GRPO: Heterogeneous Multi-Expert Mutual Learning for RLVR Advancement](https://papers.cool/arxiv/2508.09670)  #8 MEML-GRPO：用于推进 RLVR 的异构多专家相互学习

**Authors**: [Weitao Jia](https://arxiv.org/search/?searchtype=author&query=Weitao Jia), [Jinghui Lu](https://arxiv.org/search/?searchtype=author&query=Jinghui Lu), [Haiyang Yu](https://arxiv.org/search/?searchtype=author&query=Haiyang Yu), [Siqi Wang](https://arxiv.org/search/?searchtype=author&query=Siqi Wang), [Guozhi Tang](https://arxiv.org/search/?searchtype=author&query=Guozhi Tang), [An-Lan Wang](https://arxiv.org/search/?searchtype=author&query=An-Lan Wang), [Weijie Yin](https://arxiv.org/search/?searchtype=author&query=Weijie Yin), [Dingkang Yang](https://arxiv.org/search/?searchtype=author&query=Dingkang Yang), [Yuxiang Nie](https://arxiv.org/search/?searchtype=author&query=Yuxiang Nie), [Bin Shan](https://arxiv.org/search/?searchtype=author&query=Bin Shan), [Hao Feng](https://arxiv.org/search/?searchtype=author&query=Hao Feng), [Irene Li](https://arxiv.org/search/?searchtype=author&query=Irene Li), [Kun Yang](https://arxiv.org/search/?searchtype=author&query=Kun Yang), [Han Wang](https://arxiv.org/search/?searchtype=author&query=Han Wang), [Jingqun Tang](https://arxiv.org/search/?searchtype=author&query=Jingqun Tang), [Teng Fu](https://arxiv.org/search/?searchtype=author&query=Teng Fu), [Changhong Jin](https://arxiv.org/search/?searchtype=author&query=Changhong Jin), [Chao Feng](https://arxiv.org/search/?searchtype=author&query=Chao Feng), [Xiaohui Lv](https://arxiv.org/search/?searchtype=author&query=Xiaohui Lv), [Can Huang](https://arxiv.org/search/?searchtype=author&query=Can Huang)
作者：贾伟涛、陆靖晖、于海洋、王思琪、唐国志、王安岚、尹伟杰、杨定康、聂宇翔、单斌、冯浩、李艾琳、杨坤、王涵、唐静群、付腾、金昌宏、冯超、吕晓辉、黄灿
...
**Publish**: 2025-08-13 09:58:10 UTC
发布：2025-08-13 09:58:10 UTC

## [#9](https://arxiv.org/abs/2508.09639) [UbiQTree: Uncertainty Quantification in XAI with Tree Ensembles](https://papers.cool/arxiv/2508.09639)  #9 UbiQTree：基于树集成模型在可解释性人工智能中的不确定性量化

**Authors**: [Akshat Dubey](https://arxiv.org/search/?searchtype=author&query=Akshat Dubey), [Aleksandar Anžel](https://arxiv.org/search/?searchtype=author&query=Aleksandar Anžel), [Bahar İlgen](https://arxiv.org/search/?searchtype=author&query=Bahar İlgen), [Georges Hattab](https://arxiv.org/search/?searchtype=author&query=Georges Hattab)
...
**Publish**: 2025-08-13 07:59:29 UTC
出版：2025-08-13 07:59:29 协调世界时（UTC）

## [#11](https://arxiv.org/abs/2508.09507) [An Automated Multi-Modal Evaluation Framework for Mobile Intelligent Assistants](https://papers.cool/arxiv/2508.09507)  #11 一种用于移动智能助理的自动化多模态评估框架

**Authors**: [Meiping Wang](https://arxiv.org/search/?searchtype=author&query=Meiping Wang), [Jian Zhong](https://arxiv.org/search/?searchtype=author&query=Jian Zhong), [Rongduo Han](https://arxiv.org/search/?searchtype=author&query=Rongduo Han), [Liming Kang](https://arxiv.org/search/?searchtype=author&query=Liming Kang), [Zhengkun Shi](https://arxiv.org/search/?searchtype=author&query=Zhengkun Shi), [Xiao Liang](https://arxiv.org/search/?searchtype=author&query=Xiao Liang), [Xing Lin](https://arxiv.org/search/?searchtype=author&query=Xing Lin), [Nan Gao](https://arxiv.org/search/?searchtype=author&query=Nan Gao), [Haining Zhang](https://arxiv.org/search/?searchtype=author&query=Haining Zhang)
作者：王美萍、钟健、韩荣多、康利明、施正坤、梁晓、林兴、高楠、张海宁
...
随着移动智能助理技术的快速发展，多模态 AI 助手已成为日常用户交互的关键界面。然而，目前的评估方法面临着高昂的人工成本、不一致的标准和主观偏差等挑战。本文提出了一个基于大型语言模型与多代理协作的自动化多模态评估框架。该框架采用由交互评估代理、语义验证代理和体验决策代理组成的三层代理架构。通过对 Qwen3-8B 模型进行监督微调，我们在与人类专家的评估匹配准确性上取得了显著成果。在对八个主要智能代理的实验中，结果表明该框架在预测用户满意度和识别生成缺陷方面具有有效性。

**Subject**: [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：人工智能

**Publish**: 2025-08-13 05:40:34 UTC
发布：2025-08-13 05:40:34 UTC

## [#12](https://arxiv.org/abs/2508.09292) [The Othello AI Arena: Evaluating Intelligent Systems Through Limited-Time Adaptation to Unseen Boards](https://papers.cool/arxiv/2508.09292)
...
**Publish**: 2025-08-12 19:10:58 UTC
发布：2025-08-12 19:10:58 协调世界时

## [#13](https://arxiv.org/abs/2508.09277) [Value Function Initialization for Knowledge Transfer and Jump-start in Deep Reinforcement Learning](https://papers.cool/arxiv/2508.09277)  #13 价值函数初始化用于知识迁移和深度强化学习中的跳跃启动
...
**Subjects**: [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Machine Learning](https://papers.cool/arxiv/cs.LG), [Logic in Computer Science](https://papers.cool/arxiv/cs.LO)
主题：人工智能、机器学习、计算机科学中的逻辑

**Publish**: 2025-08-12 18:32:08 UTC
发布：2025-08-12 18:32:08 UTC

## [#14](https://arxiv.org/abs/2508.09987) [Echo-4o: Harnessing the Power of GPT-4o Synthetic Images for Improved Image Generation](https://papers.cool/arxiv/2508.09987)  #14 Echo-4o：利用 GPT-4o 合成图像的能力以改善图像生成

**Authors**: [Junyan Ye](https://arxiv.org/search/?searchtype=author&query=Junyan Ye), [Dongzhi Jiang](https://arxiv.org/search/?searchtype=author&query=Dongzhi Jiang), [Zihao Wang](https://arxiv.org/search/?searchtype=author&query=Zihao Wang), [Leqi Zhu](https://arxiv.org/search/?searchtype=author&query=Leqi Zhu), [Zhenghao Hu](https://arxiv.org/search/?searchtype=author&query=Zhenghao Hu), [Zilong Huang](https://arxiv.org/search/?searchtype=author&query=Zilong Huang), [Jun He](https://arxiv.org/search/?searchtype=author&query=Jun He), [Zhiyuan Yan](https://arxiv.org/search/?searchtype=author&query=Zhiyuan Yan), [Jinghua Yu](https://arxiv.org/search/?searchtype=author&query=Jinghua Yu), [Hongsheng Li](https://arxiv.org/search/?searchtype=author&query=Hongsheng Li), [Conghui He](https://arxiv.org/search/?searchtype=author&query=Conghui He), [Weijia Li](https://arxiv.org/search/?searchtype=author&query=Weijia Li)
作者：叶君研、姜东志、王梓豪、朱乐琦、胡正浩、黄子龙、何骏、颜志远、俞敬华、李宏盛、何从辉、李卫佳
...
## [#15](https://arxiv.org/abs/2508.09971) [Vision-driven River Following of UAV via Safe Reinforcement Learning using Semantic Dynamics Model](https://papers.cool/arxiv/2508.09971)  #15 通过使用语义动力学模型的安全强化学习实现无人机的视觉驱动河流跟随

**Authors**: [Zihan Wang](https://arxiv.org/search/?searchtype=author&query=Zihan Wang), [Nina Mahmoudian](https://arxiv.org/search/?searchtype=author&query=Nina Mahmoudian)
作者：王子涵，Nina Mahmoudian
...
**Publish**: 2025-08-13 17:32:40 UTC
发布时间：2025-08-13 17:32:40 UTC

## [#17](https://arxiv.org/abs/2508.09960) [GBC: Generalized Behavior-Cloning Framework for Whole-Body Humanoid Imitation](https://papers.cool/arxiv/2508.09960)  #17 GBC：用于全身类人模仿的广义行为克隆框架

**Authors**: [Yifei Yao](https://arxiv.org/search/?searchtype=author&query=Yifei Yao), [Chengyuan Luo](https://arxiv.org/search/?searchtype=author&query=Chengyuan Luo), [Jiaheng Du](https://arxiv.org/search/?searchtype=author&query=Jiaheng Du), [Wentao He](https://arxiv.org/search/?searchtype=author&query=Wentao He), [Jun-Guo Lu](https://arxiv.org/search/?searchtype=author&query=Jun-Guo Lu)
作者：姚一飞，罗承远，杜嘉恒，何文涛，陆俊国
...
**Publish**: 2025-08-13 17:28:39 UTC
发布时间：2025-08-13 17:28:39 UTC

## [#18](https://arxiv.org/abs/2508.09952) [Specialised or Generic? Tokenization Choices for Radiology Language Models](https://papers.cool/arxiv/2508.09952)  #18 专用还是通用？放射学语言模型的分词选择
...
## [#19](https://arxiv.org/abs/2508.09945) [VisCodex: Unified Multimodal Code Generation via Merging Vision and Coding Models](https://papers.cool/arxiv/2508.09945)  #19 VisCodex：通过融合视觉与编码模型实现统一的多模态代码生成

**Authors**: [Lingjie Jiang](https://arxiv.org/search/?searchtype=author&query=Lingjie Jiang), [Shaohan Huang](https://arxiv.org/search/?searchtype=author&query=Shaohan Huang), [Xun Wu](https://arxiv.org/search/?searchtype=author&query=Xun Wu), [Yixia Li](https://arxiv.org/search/?searchtype=author&query=Yixia Li), [Dongdong Zhang](https://arxiv.org/search/?searchtype=author&query=Dongdong Zhang), [Furu Wei](https://arxiv.org/search/?searchtype=author&query=Furu Wei)
作者：蒋凌杰，黄少旱，吴勋，李一夏，张东东，魏福如
...
## [#20](https://arxiv.org/abs/2508.09937) [A Comprehensive Evaluation framework of Alignment Techniques for LLMs](https://papers.cool/arxiv/2508.09937)  #20 大型语言模型（LLMs）对齐技术的综合评估框架
...
## [#21](https://arxiv.org/abs/2508.09925) [Residual Reservoir Memory Networks](https://papers.cool/arxiv/2508.09925)  #21 残差水库记忆网络

**Authors**: [Matteo Pinna](https://arxiv.org/search/?searchtype=author&query=Matteo Pinna), [Andrea Ceni](https://arxiv.org/search/?searchtype=author&query=Andrea Ceni), [Claudio Gallicchio](https://arxiv.org/search/?searchtype=author&query=Claudio Gallicchio)
...
我们在储备计算（Reservoir Computing，RC）范式下引入了一类新颖的未训练循环神经网络（RNN），称为残差储备记忆网络（Residual Reservoir Memory Networks，ResRMNs）。ResRMN 将线性记忆储备与非线性储备相结合，后者基于沿时间维度的残差正交连接，以增强输入的长期传播。通过线性稳定性分析来研究由此产生的储备状态动态，并探讨时间残差连接的多种配置。我们在时间序列和像素级一维分类任务上对所提出的方法进行了实证评估。实验结果凸显了该方法相较其他传统 RC 模型的优势。

**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：机器学习，人工智能

**Publish**: 2025-08-13 16:21:29 UTC
发布：2025-08-13 16:21:29 UTC

## [#22](https://arxiv.org/abs/2508.09919) [T-CACE: A Time-Conditioned Autoregressive Contrast Enhancement Multi-Task Framework for Contrast-Free Liver MRI Synthesis, Segmentation, and Diagnosis](https://papers.cool/arxiv/2508.09919)  #22 T-CACE：一种时间条件自回归对比度增强多任务框架，用于无对比剂肝脏 MRI 的合成、分割与诊断

**Authors**: [Xiaojiao Xiao](https://arxiv.org/search/?searchtype=author&query=Xiaojiao Xiao), [Jianfeng Zhao](https://arxiv.org/search/?searchtype=author&query=Jianfeng Zhao), [Qinmin Vivian Hu](https://arxiv.org/search/?searchtype=author&query=Qinmin Vivian Hu), [Guanghui Wang](https://arxiv.org/search/?searchtype=author&query=Guanghui Wang)
作者：肖晓娇、赵建峰、胡秦敏（Vivian Hu）、王光辉
...
**Publish**: 2025-08-13 16:14:14 UTC
发表：2025-08-13 16:14:14 UTC

## [#23](https://arxiv.org/abs/2508.09904) [Beyond Naïve Prompting: Strategies for Improved Zero-shot Context-aided Forecasting with LLMs](https://papers.cool/arxiv/2508.09904)  #23 超越简单提示：利用 LLMs 提升零样本上下文辅助预测的策略

**Authors**: [Arjun Ashok](https://arxiv.org/search/?searchtype=author&query=Arjun Ashok), [Andrew Robert Williams](https://arxiv.org/search/?searchtype=author&query=Andrew Robert Williams), [Vincent Zhihao Zheng](https://arxiv.org/search/?searchtype=author&query=Vincent Zhihao Zheng), [Irina Rish](https://arxiv.org/search/?searchtype=author&query=Irina Rish), [Nicolas Chapados](https://arxiv.org/search/?searchtype=author&query=Nicolas Chapados), [Étienne Marcotte](https://arxiv.org/search/?searchtype=author&query=Étienne Marcotte), [Valentina Zantedeschi](https://arxiv.org/search/?searchtype=author&query=Valentina Zantedeschi), [Alexandre Drouin](https://arxiv.org/search/?searchtype=author&query=Alexandre Drouin)
...
**Publish**: 2025-08-13 16:02:55 UTC
发布：2025-08-13 16:02:55 UTC

## [#24](https://arxiv.org/abs/2508.09894) [Rare anomalies require large datasets: About proving the existence of anomalies](https://papers.cool/arxiv/2508.09894)  #24 罕见异常需要大规模数据集：关于证明异常存在性的研究

**Authors**: [Simon Klüttermann](https://arxiv.org/search/?searchtype=author&query=Simon Klüttermann), [Emmanuel Müller](https://arxiv.org/search/?searchtype=author&query=Emmanuel Müller)
...
在数据集中检测是否存在任何异常对有效的异常检测至关重要，然而在异常检测文献中这一问题仍然出人意料地少有探讨。本文进行了一项全面研究，探讨了一个基本问题：何时我们能够确定无疑地断定异常存在？通过在各种异常检测任务和算法中进行超过三百万次的统计检验，我们识别出数据集大小、污染率与一个依赖于算法的常数 αalgo 之间的关系。我们的结果表明，对于一个无标签数据集，大小为 N 且污染率为 ν 的情形，不等式 N≥αalgoν2 是确认异常存在所需样本数的下界。该阈值意味着在证明异常存在变得不可行之前，异常可以稀有到怎样的程度存在一个限制。

**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：机器学习，人工智能

**Publish**: 2025-08-13 15:52:33 UTC
发布：2025-08-13 15:52:33 UTC

## [#25](https://arxiv.org/abs/2508.09886) [COME: Dual Structure-Semantic Learning with Collaborative MoE for Universal Lesion Detection Across Heterogeneous Ultrasound Datasets](https://papers.cool/arxiv/2508.09886)  #25 COME：具有协作专家混合（MoE）的双重结构-语义学习，用于跨异构超声数据集的通用病变检测

**Authors**: [Lingyu Chen](https://arxiv.org/search/?searchtype=author&query=Lingyu Chen), [Yawen Zeng](https://arxiv.org/search/?searchtype=author&query=Yawen Zeng), [Yue Wang](https://arxiv.org/search/?searchtype=author&query=Yue Wang), [Peng Wan](https://arxiv.org/search/?searchtype=author&query=Peng Wan), [Guo-chen Ning](https://arxiv.org/search/?searchtype=author&query=Guo-chen Ning), [Hongen Liao](https://arxiv.org/search/?searchtype=author&query=Hongen Liao), [Daoqiang Zhang](https://arxiv.org/search/?searchtype=author&query=Daoqiang Zhang), [Fang Chen](https://arxiv.org/search/?searchtype=author&query=Fang Chen)
作者：陈灵雨、曾雅文、王跃、万鹏、宁国臣、廖鸿恩、张道强、陈芳
...
## [#26](https://arxiv.org/abs/2508.09883) [Beyond Scaling Law: A Data-Efficient Distillation Framework for Reasoning](https://papers.cool/arxiv/2508.09883)  #26 超越缩放定律：一种用于推理的数据高效蒸馏框架

**Authors**: [Xiaojun Wu](https://arxiv.org/search/?searchtype=author&query=Xiaojun Wu), [Xiaoguang Jiang](https://arxiv.org/search/?searchtype=author&query=Xiaoguang Jiang), [Huiyang Li](https://arxiv.org/search/?searchtype=author&query=Huiyang Li), [Jucai Zhai](https://arxiv.org/search/?searchtype=author&query=Jucai Zhai), [Dengfeng Liu](https://arxiv.org/search/?searchtype=author&query=Dengfeng Liu), [Qiaobo Hao](https://arxiv.org/search/?searchtype=author&query=Qiaobo Hao), [Huang Liu](https://arxiv.org/search/?searchtype=author&query=Huang Liu), [Zhiguo Yang](https://arxiv.org/search/?searchtype=author&query=Zhiguo Yang), [Ji Xie](https://arxiv.org/search/?searchtype=author&query=Ji Xie), [Ninglun Gu](https://arxiv.org/search/?searchtype=author&query=Ninglun Gu), [Jin Yang](https://arxiv.org/search/?searchtype=author&query=Jin Yang), [Kailai Zhang](https://arxiv.org/search/?searchtype=author&query=Kailai Zhang), [Yelun Bao](https://arxiv.org/search/?searchtype=author&query=Yelun Bao), [Jun Wang](https://arxiv.org/search/?searchtype=author&query=Jun Wang)
作者：吴晓军，蒋晓光，李会阳，翟举才，刘登峰，郝巧波，刘黄，杨志国，解吉，顾宁伦，杨晋，张凯来，鲍野伦，王军
...
**Publish**: 2025-08-13 15:32:25 UTC
发布：2025-08-13 15:32:25 UTC

## [#27](https://arxiv.org/abs/2508.09874) [Memory Decoder: A Pretrained, Plug-and-Play Memory for Large Language Models](https://papers.cool/arxiv/2508.09874)  #27 Memory Decoder: A Pretrained, Plug-and-Play Memory for Large Language Models
...
## [#28](https://arxiv.org/abs/2508.09853) [STREAM (ChemBio): A Standard for Transparently Reporting Evaluations in AI Model Reports](https://papers.cool/arxiv/2508.09853)  #28 STREAM（化学生物）：在人工智能模型报告中透明报告评估的标准

**Authors**: [Tegan McCaslin](https://arxiv.org/search/?searchtype=author&query=Tegan McCaslin), [Jide Alaga](https://arxiv.org/search/?searchtype=author&query=Jide Alaga), [Samira Nedungadi](https://arxiv.org/search/?searchtype=author&query=Samira Nedungadi), [Seth Donoughe](https://arxiv.org/search/?searchtype=author&query=Seth Donoughe), [Tom Reed](https://arxiv.org/search/?searchtype=author&query=Tom Reed), [Rishi Bommasani](https://arxiv.org/search/?searchtype=author&query=Rishi Bommasani), [Chris Painter](https://arxiv.org/search/?searchtype=author&query=Chris Painter), [Luca Righetti](https://arxiv.org/search/?searchtype=author&query=Luca Righetti)
...
**Publish**: 2025-08-13 14:36:36 UTC
发布：2025-08-13 14:36:36 UTC

## [#29](https://arxiv.org/abs/2508.09852) [Perceptual Reality Transformer: Neural Architectures for Simulating Neurological Perception Conditions](https://papers.cool/arxiv/2508.09852)  #29 感知现实变换器：用于模拟神经感知状况的神经网络架构
...
**Subjects**: [Neurons and Cognition](https://papers.cool/arxiv/q-bio.NC), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Computer Vision and Pattern Recognition](https://papers.cool/arxiv/cs.CV), [Neural and Evolutionary Computing](https://papers.cool/arxiv/cs.NE)

**Publish**: 2025-08-13 14:34:33 UTC
发布：2025-08-13 14:34:33 UTC

## [#30](https://arxiv.org/abs/2508.09848) [PRELUDE: A Benchmark Designed to Require Global Comprehension and Reasoning over Long Contexts](https://papers.cool/arxiv/2508.09848)  #30 序曲：一个旨在要求对长上下文进行全局理解和推理的基准

**Authors**: [Mo Yu](https://arxiv.org/search/?searchtype=author&query=Mo Yu), [Tsz Ting Chung](https://arxiv.org/search/?searchtype=author&query=Tsz Ting Chung), [Chulun Zhou](https://arxiv.org/search/?searchtype=author&query=Chulun Zhou), [Tong Li](https://arxiv.org/search/?searchtype=author&query=Tong Li), [Rui Lu](https://arxiv.org/search/?searchtype=author&query=Rui Lu), [Jiangnan Li](https://arxiv.org/search/?searchtype=author&query=Jiangnan Li), [Liyan Xu](https://arxiv.org/search/?searchtype=author&query=Liyan Xu), [Haoshu Lu](https://arxiv.org/search/?searchtype=author&query=Haoshu Lu), [Ning Zhang](https://arxiv.org/search/?searchtype=author&query=Ning Zhang), [Jing Li](https://arxiv.org/search/?searchtype=author&query=Jing Li), [Jie Zhou](https://arxiv.org/search/?searchtype=author&query=Jie Zhou)
作者：于墨、钟子霆、周楚伦、李彤、卢睿、李江南、许丽妍、卢浩书、张宁、李静、周杰
...
**Publish**: 2025-08-13 14:28:25 UTC
发布时间：2025-08-13 14:28:25 UTC

## [#31](https://arxiv.org/abs/2508.09834) [Speed Always Wins: A Survey on Efficient Architectures for Large Language Models](https://papers.cool/arxiv/2508.09834)  #31 速度永远胜出：关于大型语言模型高效架构的综述

**Authors**: [Weigao Sun](https://arxiv.org/search/?searchtype=author&query=Weigao Sun), [Jiaxi Hu](https://arxiv.org/search/?searchtype=author&query=Jiaxi Hu), [Yucheng Zhou](https://arxiv.org/search/?searchtype=author&query=Yucheng Zhou), [Jusen Du](https://arxiv.org/search/?searchtype=author&query=Jusen Du), [Disen Lan](https://arxiv.org/search/?searchtype=author&query=Disen Lan), [Kexin Wang](https://arxiv.org/search/?searchtype=author&query=Kexin Wang), [Tong Zhu](https://arxiv.org/search/?searchtype=author&query=Tong Zhu), [Xiaoye Qu](https://arxiv.org/search/?searchtype=author&query=Xiaoye Qu), [Yu Zhang](https://arxiv.org/search/?searchtype=author&query=Yu Zhang), [Xiaoyu Mo](https://arxiv.org/search/?searchtype=author&query=Xiaoyu Mo), [Daizong Liu](https://arxiv.org/search/?searchtype=author&query=Daizong Liu), [Yuxuan Liang](https://arxiv.org/search/?searchtype=author&query=Yuxuan Liang), [Wenliang Chen](https://arxiv.org/search/?searchtype=author&query=Wenliang Chen), [Guoqi Li](https://arxiv.org/search/?searchtype=author&query=Guoqi Li), [Yu Cheng](https://arxiv.org/search/?searchtype=author&query=Yu Cheng)
作者：孙维高、胡嘉熙、周宇成、杜居森、兰迪森、王可昕、朱彤、曲晓烨、张宇、莫晓雨、刘代宗、梁昱轩、陈文亮、李国齐、程煜
...
**Publish**: 2025-08-13 14:13:46 UTC
发布：2025-08-13 14:13:46 协调世界时 (UTC)

## [#32](https://arxiv.org/abs/2508.09832) [Exploring the Potential of Large Language Models in Fine-Grained Review Comment Classification](https://papers.cool/arxiv/2508.09832)  #32 探索大型语言模型在细粒度审稿意见分类中的潜力

**Authors**: [Linh Nguyen](https://arxiv.org/search/?searchtype=author&query=Linh Nguyen), [Chunhua Liu](https://arxiv.org/search/?searchtype=author&query=Chunhua Liu), [Hong Yi Lin](https://arxiv.org/search/?searchtype=author&query=Hong Yi Lin), [Patanamon Thongtanunam](https://arxiv.org/search/?searchtype=author&query=Patanamon Thongtanunam)
...
**Publish**: 2025-08-13 14:07:05 UTC
发布时间：2025-08-13 14:07:05 UTC

## [#33](https://arxiv.org/abs/2508.09830) [RayletDF: Raylet Distance Fields for Generalizable 3D Surface Reconstruction from Point Clouds or Gaussians](https://papers.cool/arxiv/2508.09830)  #33 RayletDF：用于从点云或高斯分布进行可泛化三维表面重建的 Raylet 距离场
...
**Subjects**: [Computer Vision and Pattern Recognition](https://papers.cool/arxiv/cs.CV), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Graphics](https://papers.cool/arxiv/cs.GR), [Machine Learning](https://papers.cool/arxiv/cs.LG), [Robotics](https://papers.cool/arxiv/cs.RO)
主题：计算机视觉与模式识别、人工智能、图形学、机器学习、机器人学

**Publish**: 2025-08-13 14:05:21 UTC
发布：2025-08-13 14:05:21 UTC

## [#34](https://arxiv.org/abs/2508.09820) [Provable In-Context Vector Arithmetic via Retrieving Task Concepts](https://papers.cool/arxiv/2508.09820)  #34 可证明的上下文内向量算术通过检索任务概念

**Authors**: [Dake Bu](https://arxiv.org/search/?searchtype=author&query=Dake Bu), [Wei Huang](https://arxiv.org/search/?searchtype=author&query=Wei Huang), [Andi Han](https://arxiv.org/search/?searchtype=author&query=Andi Han), [Atsushi Nitanda](https://arxiv.org/search/?searchtype=author&query=Atsushi Nitanda), [Qingfu Zhang](https://arxiv.org/search/?searchtype=author&query=Qingfu Zhang), [Hau-San Wong](https://arxiv.org/search/?searchtype=author&query=Hau-San Wong), [Taiji Suzuki](https://arxiv.org/search/?searchtype=author&query=Taiji Suzuki)
作者：段克（Dake Bu）、黄伟（Wei Huang）、韩安迪（Andi Han）、仁田敦（Atsushi Nitanda）、张庆福（Qingfu Zhang）、黄皓山（Hau-San Wong）、铃木太治（Taiji Suzuki）
...
**Publish**: 2025-08-13 13:54:44 UTC
发布：2025-08-13 13:54:44 协调世界时（UTC）

## [#35](https://arxiv.org/abs/2508.09811) [TRACE: Learning 3D Gaussian Physical Dynamics from Multi-view Videos](https://papers.cool/arxiv/2508.09811)  #35 TRACE：从多视角视频学习三维高斯物理动力学

**Authors**: [Jinxi Li](https://arxiv.org/search/?searchtype=author&query=Jinxi Li), [Ziyang Song](https://arxiv.org/search/?searchtype=author&query=Ziyang Song), [Bo Yang](https://arxiv.org/search/?searchtype=author&query=Bo Yang)
作者：李津熙，宋子洋，杨博
...
**Subjects**: [Computer Vision and Pattern Recognition](https://papers.cool/arxiv/cs.CV), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Computational Engineering, Finance, and Science](https://papers.cool/arxiv/cs.CE), [Machine Learning](https://papers.cool/arxiv/cs.LG), [Robotics](https://papers.cool/arxiv/cs.RO)
主题：计算机视觉与模式识别、人工智能、计算工程、金融与科学、机器学习、机器人学

**Publish**: 2025-08-13 13:43:01 UTC
发表时间：2025-08-13 13:43:01 UTC

## [#36](https://arxiv.org/abs/2508.09809) [A Comprehensive Survey of Datasets for Clinical Mental Health AI Systems](https://papers.cool/arxiv/2508.09809)  #36 临床心理健康人工智能系统数据集的全面综述
...
## [#37](https://arxiv.org/abs/2508.09805) [Automated Segmentation of Coronal Brain Tissue Slabs for 3D Neuropathology](https://papers.cool/arxiv/2508.09805)  #37 额外用于三维神经病理学的冠状脑组织切片自动分割

**Authors**: [Jonathan Williams Ramirez](https://arxiv.org/search/?searchtype=author&query=Jonathan Williams Ramirez), [Dina Zemlyanker](https://arxiv.org/search/?searchtype=author&query=Dina Zemlyanker), [Lucas Deden-Binder](https://arxiv.org/search/?searchtype=author&query=Lucas Deden-Binder), [Rogeny Herisse](https://arxiv.org/search/?searchtype=author&query=Rogeny Herisse), [Erendira Garcia Pallares](https://arxiv.org/search/?searchtype=author&query=Erendira Garcia Pallares), [Karthik Gopinath](https://arxiv.org/search/?searchtype=author&query=Karthik Gopinath), [Harshvardhan Gazula](https://arxiv.org/search/?searchtype=author&query=Harshvardhan Gazula), [Christopher Mount](https://arxiv.org/search/?searchtype=author&query=Christopher Mount), [Liana N. Kozanno](https://arxiv.org/search/?searchtype=author&query=Liana N. Kozanno), [Michael S. Marshall](https://arxiv.org/search/?searchtype=author&query=Michael S. Marshall), [Theresa R. Connors](https://arxiv.org/search/?searchtype=author&query=Theresa R. Connors), [Matthew P. Frosch](https://arxiv.org/search/?searchtype=author&query=Matthew P. Frosch), [Mark Montine](https://arxiv.org/search/?searchtype=author&query=Mark Montine), [Derek H. Oakley](https://arxiv.org/search/?searchtype=author&query=Derek H. Oakley), [Christine L. Mac Donald](https://arxiv.org/search/?searchtype=author&query=Christine L. Mac Donald), [C. Dirk Keene](https://arxiv.org/search/?searchtype=author&query=C. Dirk Keene), [Bradley T. Hyman](https://arxiv.org/search/?searchtype=author&query=Bradley T. Hyman), [Juan Eugenio Iglesias](https://arxiv.org/search/?searchtype=author&query=Juan Eugenio Iglesias)
...
在现代计算环境中，恶意软件检测要求模型不仅要准确，还要具有可解释性并对规避技术具有鲁棒性。图神经网络（GNN）在该领域显示出潜力，因为它们能够对基于图的程序表示（例如控制流图，CFG）中的丰富结构依赖进行建模。然而，单一模型方法可能在泛化能力上有限，并且缺乏可解释性，尤其是在高风险的安全应用中。本文提出了一种用于基于图的恶意软件检测和解释的新型堆叠集成框架。我们的方法从便携式可执行文件（PE）中动态提取 CFG，并通过两步嵌入策略对其基本块进行编码。一组多样化的 GNN 基学习器，每个都有不同的信息传递机制，用于捕捉互补的行为特征。它们的预测输出由一个作为基于注意力的多层感知器实现的元学习器聚合，该元学习器既对恶意软件实例进行分类，又量化每个基模型的贡献。 为增强可解释性，我们提出了一种面向集成模型的事后解释技术，该技术利用 GNN 解释器生成的边级重要性评分，并使用学习到的注意力权重将其融合。这样可以产生与最终集成决策一致的、可解释且与模型无关的解释。实验结果表明，我们的框架在提升分类性能的同时，还能提供对恶意软件行为的有见地解释。

**Subjects**: [Cryptography and Security](https://papers.cool/arxiv/cs.CR), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：密码学与安全性 , 人工智能

**Publish**: 2025-08-13 13:33:02 UTC
发布时间：2025-08-13 13:33:02 世界协调时 (UTC)

## [#39](https://arxiv.org/abs/2508.09791) [LibRec: Benchmarking Retrieval-Augmented LLMs for Library Migration Recommendations](https://papers.cool/arxiv/2508.09791)  #39 LibRec：基于检索增强 LLMs 的库迁移推荐基准测试

**Authors**: [Junxiao Han](https://arxiv.org/search/?searchtype=author&query=Junxiao Han), [Yarong Wang](https://arxiv.org/search/?searchtype=author&query=Yarong Wang), [Xiaodong Gu](https://arxiv.org/search/?searchtype=author&query=Xiaodong Gu), [Cuiyun Gao](https://arxiv.org/search/?searchtype=author&query=Cuiyun Gao), [Yao Wan](https://arxiv.org/search/?searchtype=author&query=Yao Wan), [Song Han](https://arxiv.org/search/?searchtype=author&query=Song Han), [David Lo](https://arxiv.org/search/?searchtype=author&query=David Lo), [Shuiguang Deng](https://arxiv.org/search/?searchtype=author&query=Shuiguang Deng)
作者：韩俊晓、王雅蓉、顾晓东、高翠云、万尧、韩松、David Lo、邓水广
...
## [#40](https://arxiv.org/abs/2508.09787) [Prototype Training with Dual Pseudo-Inverse and Optimized Hidden Activations](https://papers.cool/arxiv/2508.09787)  #40 使用双伪逆和优化隐藏激活的原型训练
...
我们提出了 Proto-PINV+H，一种快速训练范式，将闭式权重计算与对一小组合成输入、软标签及——关键——隐藏激活的基于梯度的优化相结合。在每次迭代中，我们通过两次（或更多次）带岭回归正则化的伪逆求解以闭式重算所有权重矩阵，同时仅用 Adam 更新原型。因此，可训练的自由度从权重空间转移到了数据/激活空间。在 MNIST（60k 训练，10k 测试）和 Fashion-MNIST（60k 训练，10k 测试）上，我们的方法分别在官方 10k 测试集上以约 13 万 可训练参数和仅 250 个 epoch，在 RTX 5060（16GB）上用时 3.9s–4.5s 达到 97.8% 和 89.3% 的测试准确率。我们提供了多层扩展（对每个隐藏阶段优化激活）、可学习的岭参数、可选的 PCA/PLS 投影，以及将原型矩阵的条件数与泛化联系起来的理论。该方法在准确率—速度—模型大小权衡上优于 ELM、随机特征岭回归和通过反向传播训练的浅层 MLP。

**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：机器学习，人工智能

**Publish**: 2025-08-13 13:13:32 UTC
发布：2025-08-13 13:13:32 UTC

## [#41](https://arxiv.org/abs/2508.09786) [Adoption of Explainable Natural Language Processing: Perspectives from Industry and Academia on Practices and Challenges](https://papers.cool/arxiv/2508.09786)  #41 可解释自然语言处理的采纳：来自产业界与学术界关于实践与挑战的观点
...
**Publish**: 2025-08-13 13:01:24 UTC
发布：2025-08-13 13:01:24 UTC

## [#43](https://arxiv.org/abs/2508.09776) [Can LLM-Generated Textual Explanations Enhance Model Classification Performance? An Empirical Study](https://papers.cool/arxiv/2508.09776)  #43 LLM 生成的文本解释能否提高模型的分类表现？一项实证研究
...
## [#44](https://arxiv.org/abs/2508.09768) [Counting Short Trajectories in Elementary Cellular Automata using the Transfer Matrix Method](https://papers.cool/arxiv/2508.09768)  #44 使用转移矩阵方法计算元胞自动机中的短轨迹数量

**Authors**: [Cédric Koller](https://arxiv.org/search/?searchtype=author&query=Cédric Koller), [Barbora Hudcová](https://arxiv.org/search/?searchtype=author&query=Barbora Hudcová)
...
**Subjects**: [Cellular Automata and Lattice Gases](https://papers.cool/arxiv/nlin.CG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Neural and Evolutionary Computing](https://papers.cool/arxiv/cs.NE), [Chaotic Dynamics](https://papers.cool/arxiv/nlin.CD)
主题: 细胞自动机与晶格气、人工智能、神经与进化计算、混沌动力学

**Publish**: 2025-08-13 12:53:22 UTC
发表: 2025-08-13 12:53:22 UTC

## [#45](https://arxiv.org/abs/2508.09765) [Enhance the machine learning algorithm performance in phishing detection with keyword features](https://papers.cool/arxiv/2508.09765)  #45 使用关键字特征提高机器学习算法在网络钓鱼检测中的性能 [PDF ] [Copy] [Kimi ] [REL]
...
**Subjects**: [Cryptography and Security](https://papers.cool/arxiv/cs.CR), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Machine Learning](https://papers.cool/arxiv/cs.LG), [Neural and Evolutionary Computing](https://papers.cool/arxiv/cs.NE)
学科：密码学与安全、人工智能、机器学习、神经与进化计算

**Publish**: 2025-08-12 14:16:11 UTC
发表：2025-08-12 14:16:11 UTC

## [#46](https://arxiv.org/abs/2508.09757) [NEUBORN: The Neurodevelopmental Evolution framework Using BiOmechanical RemodelliNg](https://papers.cool/arxiv/2508.09757)  #46 NEUBORN：使用生物力学重塑的神经发育进化框架
...
**Publish**: 2025-08-13 11:19:30 UTC
发布日期：2025-08-13 11:19:30 UTC

## [#49](https://arxiv.org/abs/2508.09713) [Evaluating the Role of Large Language Models in Legal Practice in India](https://papers.cool/arxiv/2508.09713)  #49 评估大型语言模型在印度法律实践中的作用
...
**Publish**: 2025-08-13 09:44:51 UTC
发布：2025-08-13 09:44:51 UTC

## [#52](https://arxiv.org/abs/2508.09653) [On Negative-aware Preference Optimization for Recommendation](https://papers.cool/arxiv/2508.09653)  #52 关于用于推荐的负面感知偏好优化

**Authors**: [Chenlu Ding](https://arxiv.org/search/?searchtype=author&query=Chenlu Ding), [Daoxuan Liu](https://arxiv.org/search/?searchtype=author&query=Daoxuan Liu), [Jiancan Wu](https://arxiv.org/search/?searchtype=author&query=Jiancan Wu), [Xingyu Hu](https://arxiv.org/search/?searchtype=author&query=Xingyu Hu), [Junkang Wu](https://arxiv.org/search/?searchtype=author&query=Junkang Wu), [Haitao Wang](https://arxiv.org/search/?searchtype=author&query=Haitao Wang), [Yongkang Wang](https://arxiv.org/search/?searchtype=author&query=Yongkang Wang), [Xingxing Wang](https://arxiv.org/search/?searchtype=author&query=Xingxing Wang), [Xiang Wang](https://arxiv.org/search/?searchtype=author&query=Xiang Wang)
作者：丁晨璐、刘道轩、吴建灿、胡星宇、吴俊康、王海涛、王永康、王星星、王翔
...
**Publish**: 2025-08-13 09:35:51 UTC
发布：2025-08-13 09:35:51 UTC

## [#54](https://arxiv.org/abs/2508.09651) [A Close Reading Approach to Gender Narrative Biases in AI-Generated Stories](https://papers.cool/arxiv/2508.09651)  #54 一种对 AI 生成故事中性别叙事偏见的细读方法

**Authors**: [Daniel Raffini](https://arxiv.org/search/?searchtype=author&query=Daniel Raffini), [Agnese Macori](https://arxiv.org/search/?searchtype=author&query=Agnese Macori), [Marco Angelini](https://arxiv.org/search/?searchtype=author&query=Marco Angelini), [Tiziana Catarci](https://arxiv.org/search/?searchtype=author&query=Tiziana Catarci)

The paper explores the study of gender-based narrative biases in stories generated by ChatGPT, Gemini, and Claude. The prompt design draws on Propp's character classifications and Freytag's narrative structure. The stories are analyzed through a close reading approach, with particular attention to adherence to the prompt, gender distribution of characters, physical and psychological descriptions, actions, and finally, plot development and character relationships. The results reveal the persistence of biases - especially implicit ones - in the generated stories and highlight the importance of assessing biases at multiple levels using an interpretative approach.
本文探讨了由 ChatGPT、Gemini 和 Claude 生成的故事中基于性别的叙事偏见研究。提示设计借鉴了普罗甫（Propp）的人物分类和弗雷塔格（Freytag）的叙事结构。通过精读方法对故事进行分析，特别关注对提示的遵从情况、人物的性别分布、身体与心理描写、行为以及最终的情节发展和人物关系。结果显示生成的故事中偏见，尤其是隐含偏见，仍然存在，并突显了使用解释性方法在多个层面评估偏见的重要性。
...
**Publish**: 2025-08-13 09:08:51 UTC
发表时间：2025-08-13 09:08:51 UTC

## [#56](https://arxiv.org/abs/2508.09631) [AmbiGraph-Eval: Can LLMs Effectively Handle Ambiguous Graph Queries?](https://papers.cool/arxiv/2508.09631)  #56 AmbiGraph-Eval：LLMs 能有效处理含糊的图查询吗？ [PDF 1 ] [Copy] [Kimi ] [REL]

**Authors**: [Yuchen Tian](https://arxiv.org/search/?searchtype=author&query=Yuchen Tian), [Kaixin Li](https://arxiv.org/search/?searchtype=author&query=Kaixin Li), [Hao Chen](https://arxiv.org/search/?searchtype=author&query=Hao Chen), [Ziyang Luo](https://arxiv.org/search/?searchtype=author&query=Ziyang Luo), [Hongzhan Lin](https://arxiv.org/search/?searchtype=author&query=Hongzhan Lin), [Sebastian Schelter](https://arxiv.org/search/?searchtype=author&query=Sebastian Schelter), [Lun Du](https://arxiv.org/search/?searchtype=author&query=Lun Du), [Jing Ma](https://arxiv.org/search/?searchtype=author&query=Jing Ma)
作者：田昱晨、李凯鑫、陈浩、罗子扬、林鸿展、Sebastian Schelter、杜伦、马静
...
**Publish**: 2025-08-13 08:53:13 UTC
发布：2025-08-13 08:53:13 UTC

## [#60](https://arxiv.org/abs/2508.09616) [MInDI-3D: Iterative Deep Learning in 3D for Sparse-view Cone Beam Computed Tomography](https://papers.cool/arxiv/2508.09616)  #60 MInDI-3D：用于稀视角锥形束计算机断层扫描的三维迭代深度学习

**Authors**: [Daniel Barco](https://arxiv.org/search/?searchtype=author&query=Daniel Barco), [Marc Stadelmann](https://arxiv.org/search/?searchtype=author&query=Marc Stadelmann), [Martin Oswald](https://arxiv.org/search/?searchtype=author&query=Martin Oswald), [Ivo Herzig](https://arxiv.org/search/?searchtype=author&query=Ivo Herzig), [Lukas Lichtensteiger](https://arxiv.org/search/?searchtype=author&query=Lukas Lichtensteiger), [Pascal Paysan](https://arxiv.org/search/?searchtype=author&query=Pascal Paysan), [Igor Peterlik](https://arxiv.org/search/?searchtype=author&query=Igor Peterlik), [Michal Walczak](https://arxiv.org/search/?searchtype=author&query=Michal Walczak), [Bjoern Menze](https://arxiv.org/search/?searchtype=author&query=Bjoern Menze), [Frank-Peter Schilling](https://arxiv.org/search/?searchtype=author&query=Frank-Peter Schilling)
...
发布：2025-08-13 08:49:18 UTC

## [#61](https://arxiv.org/abs/2508.09614) [How Persuasive Could LLMs Be? A First Study Combining Linguistic-Rhetorical Analysis and User Experiments](https://papers.cool/arxiv/2508.09614)  #61 LLMs 的说服力能有多强？一项结合语言修辞分析与用户实验的首次研究
...
## [#62](https://arxiv.org/abs/2508.09602) [A Lightweight Learned Cardinality Estimation Model](https://papers.cool/arxiv/2508.09602)  #62 一个轻量级的学习型基数估计模型

**Authors**: [Yaoyu Zhu](https://arxiv.org/search/?searchtype=author&query=Yaoyu Zhu), [Jintao Zhang](https://arxiv.org/search/?searchtype=author&query=Jintao Zhang), [Guoliang Li](https://arxiv.org/search/?searchtype=author&query=Guoliang Li), [Jianhua Feng](https://arxiv.org/search/?searchtype=author&query=Jianhua Feng)
作者：朱耀宇，张金涛，李国良，冯建华
...
**Subjects**: [Databases](https://papers.cool/arxiv/cs.DB), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Machine Learning](https://papers.cool/arxiv/cs.LG)
学科：数据库、人工智能、机器学习

**Publish**: 2025-08-13 08:34:58 UTC
发表：2025-08-13 08:34:58 UTC

## [#63](https://arxiv.org/abs/2508.09593) [Hierarchical Brain Structure Modeling for Predicting Genotype of Glioma](https://papers.cool/arxiv/2508.09593)  #63 用于预测胶质瘤基因型的层次化大脑结构建模

**Authors**: [Haotian Tang](https://arxiv.org/search/?searchtype=author&query=Haotian Tang), [Jianwei Chen](https://arxiv.org/search/?searchtype=author&query=Jianwei Chen), [Xinrui Tang](https://arxiv.org/search/?searchtype=author&query=Xinrui Tang), [Yunjia Wu](https://arxiv.org/search/?searchtype=author&query=Yunjia Wu), [Zhengyang Miao](https://arxiv.org/search/?searchtype=author&query=Zhengyang Miao), [Chao Li](https://arxiv.org/search/?searchtype=author&query=Chao Li)
...
**Publish**: 2025-08-13 08:17:54 UTC
发布：2025-08-13 08:17:54 世界协调时

## [#64](https://arxiv.org/abs/2508.09558) [CaRoBio: 3D Cable Routing with a Bio-inspired Gripper Fingernail](https://papers.cool/arxiv/2508.09558)  #64 CaRoBio：带有仿生抓握指甲的三维电缆布线

**Authors**: [Jiahui Zuo](https://arxiv.org/search/?searchtype=author&query=Jiahui Zuo), [Boyang Zhang](https://arxiv.org/search/?searchtype=author&query=Boyang Zhang), [Fumin Zhang](https://arxiv.org/search/?searchtype=author&query=Fumin Zhang)
作者：左嘉辉、张博阳、张富民
...
**Publish**: 2025-08-13 07:25:40 UTC
发布时间：2025-08-13 07:25:40 UTC

## [#65](https://arxiv.org/abs/2508.09547) [GoViG: Goal-Conditioned Visual Navigation Instruction Generation](https://papers.cool/arxiv/2508.09547)  #65 GoViG：面向目标的视觉导航指令生成

**Authors**: [Fengyi Wu](https://arxiv.org/search/?searchtype=author&query=Fengyi Wu), [Yifei Dong](https://arxiv.org/search/?searchtype=author&query=Yifei Dong), [Zhi-Qi Cheng](https://arxiv.org/search/?searchtype=author&query=Zhi-Qi Cheng), [Yilong Dai](https://arxiv.org/search/?searchtype=author&query=Yilong Dai), [Guangyu Chen](https://arxiv.org/search/?searchtype=author&query=Guangyu Chen), [Hang Wang](https://arxiv.org/search/?searchtype=author&query=Hang Wang), [Qi Dai](https://arxiv.org/search/?searchtype=author&query=Qi Dai), [Alexander G. Hauptmann](https://arxiv.org/search/?searchtype=author&query=Alexander G. Hauptmann)
作者：吴峰逸、董一飞、程志琦、戴逸龙、陈光宇、王航、戴琦、Alexander G. Hauptmann
...
**Publish**: 2025-08-13 07:05:17 UTC
发布：2025-08-13 07:05:17 UTC

## [#66](https://arxiv.org/abs/2508.09537) [Your Coding Intent is Secretly in the Context and You Should Deliberately Infer It Before Completion](https://papers.cool/arxiv/2508.09537)  #66 你的编码意图其实隐藏在上下文中——在完成之前你应当有意推断它
...
**Publish**: 2025-08-13 06:45:23 UTC
发布：2025-08-13 06:45:23 协调世界时 (UTC)

## [#67](https://arxiv.org/abs/2508.09535) [AI Blob! LLM-Driven Recontextualization of Italian Television Archives](https://papers.cool/arxiv/2508.09535)  #67 AI Blob！由 LLM 驱动的意大利电视档案再语境化
...
**Publish**: 2025-08-13 06:30:03 UTC
发布：2025-08-13 06:30:03 UTC

## [#69](https://arxiv.org/abs/2508.09532) [Decentralized Rank Scheduling for Energy-Constrained Multi-Task Federated Fine-Tuning in Edge-Assisted IoV Networks](https://papers.cool/arxiv/2508.09532)  #69 去中心化秩调度用于边缘辅助车联网网络中受能量限制的多任务联邦微调

**Authors**: [Bokeng Zheng](https://arxiv.org/search/?searchtype=author&query=Bokeng Zheng), [Jianqiang Zhong](https://arxiv.org/search/?searchtype=author&query=Jianqiang Zhong), [Jiayi Liu](https://arxiv.org/search/?searchtype=author&query=Jiayi Liu), [Xiaoxi Zhang](https://arxiv.org/search/?searchtype=author&query=Xiaoxi Zhang)
作者：郑博耕、钟建强、刘佳怡、张晓曦
...
**Publish**: 2025-08-13 06:29:00 UTC
发布：2025-08-13 06:29:00 UTC

## [#70](https://arxiv.org/abs/2508.09522) [Generation of Indian Sign Language Letters, Numbers, and Words](https://papers.cool/arxiv/2508.09522)  #70 印度手语字母、数字与单词的生成

**Authors**: [Ajeet Kumar Yadav](https://arxiv.org/search/?searchtype=author&query=Ajeet Kumar Yadav), [Nishant Kumar](https://arxiv.org/search/?searchtype=author&query=Nishant Kumar), [Rathna G N](https://arxiv.org/search/?searchtype=author&query=Rathna G N)
...
**Publish**: 2025-08-13 06:10:20 UTC
发布时间：2025-08-13 06:10:20 UTC

## [#71](https://arxiv.org/abs/2508.09521) [COMPEER: Controllable Empathetic Reinforcement Reasoning for Emotional Support Conversation](https://papers.cool/arxiv/2508.09521)  #71 COMPEER：用于情感支持对话的可控共情强化推理

**Authors**: [Yunxiao Wang](https://arxiv.org/search/?searchtype=author&query=Yunxiao Wang), [Meng Liu](https://arxiv.org/search/?searchtype=author&query=Meng Liu), [Wenqi Liu](https://arxiv.org/search/?searchtype=author&query=Wenqi Liu), [Kaiyu Jiang](https://arxiv.org/search/?searchtype=author&query=Kaiyu Jiang), [Bin Wen](https://arxiv.org/search/?searchtype=author&query=Bin Wen), [Fan Yang](https://arxiv.org/search/?searchtype=author&query=Fan Yang), [Tingting Gao](https://arxiv.org/search/?searchtype=author&query=Tingting Gao), [Guorui Zhou](https://arxiv.org/search/?searchtype=author&query=Guorui Zhou), [Liqiang Nie](https://arxiv.org/search/?searchtype=author&query=Liqiang Nie)
作者：王云晓、刘萌、刘文琦、蒋凯宇、温斌、杨帆、高婷婷、周国瑞、聂立强
...
## [#72](https://arxiv.org/abs/2508.09508) [SMART-OC: A Real-time Time-risk Optimal Replanning Algorithm for Dynamic Obstacles and Spatio-temporally Varying Currents](https://papers.cool/arxiv/2508.09508)  #72 SMART-OC：一种用于动态障碍物和时空变化洋流的实时时间-风险最优重规划算法

**Authors**: [Reema Raval](https://arxiv.org/search/?searchtype=author&query=Reema Raval), [Shalabh Gupta](https://arxiv.org/search/?searchtype=author&query=Shalabh Gupta)
...
典型的海洋环境高度复杂，具有时空变化的洋流和动态障碍物，这给无人水面船（USV）的安全与高效导航带来了重大挑战。因此，USV 需要利用实时信息持续调整其航线，以避开碰撞并通过利用洋流沿着阻力最小的路径前往目标。为此，我们提出了一种新算法，称为用于动态障碍物和洋流的自我变形自适应重规划树（SMART-OC），该算法促进在动态环境中的实时时间-风险最优重规划。SMART-OC 将路径上的障碍风险与到达目标的时间成本相结合，以寻找时间-风险最优路径。通过仿真实验验证了 SMART-OC 的有效性，实验表明 USV 能够快速重规划以避开动态障碍物并利用洋流成功到达目标。

**Subjects**: [Robotics](https://papers.cool/arxiv/cs.RO), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：机器人学，人工智能

**Publish**: 2025-08-13 05:42:25 UTC
发布：2025-08-13 05:42:25 UTC

## [#73](https://arxiv.org/abs/2508.09505) [Verify Distributed Deep Learning Model Implementation Refinement with Iterative Relation Inference](https://papers.cool/arxiv/2508.09505)  #73 验证分布式深度学习模型实现的精炼与迭代关系推断

**Authors**: [Zhanghan Wang](https://arxiv.org/search/?searchtype=author&query=Zhanghan Wang), [Ding Ding](https://arxiv.org/search/?searchtype=author&query=Ding Ding), [Hang Zhu](https://arxiv.org/search/?searchtype=author&query=Hang Zhu), [Haibin Lin](https://arxiv.org/search/?searchtype=author&query=Haibin Lin), [Aurojit Panda](https://arxiv.org/search/?searchtype=author&query=Aurojit Panda)
...
**Publish**: 2025-08-13 05:33:25 UTC
发布：2025-08-13 05:33:25 UTC

## [#74](https://arxiv.org/abs/2508.09497) [From Ranking to Selection: A Simple but Efficient Dynamic Passage Selector for Retrieval Augmented Generation](https://papers.cool/arxiv/2508.09497)  #74 从排序到选择：一种简单但高效的用于检索增强生成的动态段落选择器

**Authors**: [Siyuan Meng](https://arxiv.org/search/?searchtype=author&query=Siyuan Meng), [Junming Liu](https://arxiv.org/search/?searchtype=author&query=Junming Liu), [Yirong Chen](https://arxiv.org/search/?searchtype=author&query=Yirong Chen), [Song Mao](https://arxiv.org/search/?searchtype=author&query=Song Mao), [Pinlong Cai](https://arxiv.org/search/?searchtype=author&query=Pinlong Cai), [Guohang Yan](https://arxiv.org/search/?searchtype=author&query=Guohang Yan), [Botian Shi](https://arxiv.org/search/?searchtype=author&query=Botian Shi), [Ding Wang](https://arxiv.org/search/?searchtype=author&query=Ding Wang)
作者：孟思远，刘俊铭，陈艺蓉，毛松，蔡品龙，颜国航，史博天，王丁
...
## [#75](https://arxiv.org/abs/2508.09494) [Learning Facts at Scale with Active Reading](https://papers.cool/arxiv/2508.09494)  #75 通过主动阅读在大规模上学习事实
...
## [#76](https://arxiv.org/abs/2508.09489) [Large-Small Model Collaborative Framework for Federated Continual Learning](https://papers.cool/arxiv/2508.09489)  #76 大-小模型协同框架用于联邦持续学习
...
**Publish**: 2025-08-13 04:49:50 UTC
发表：2025-08-13 04:49:50 世界协调时间 (UTC)

## [#77](https://arxiv.org/abs/2508.09486) [Episodic Memory Representation for Long-form Video Understanding](https://papers.cool/arxiv/2508.09486)  #77 情景记忆表示用于长视频理解

**Authors**: [Yun Wang](https://arxiv.org/search/?searchtype=author&query=Yun Wang), [Long Zhang](https://arxiv.org/search/?searchtype=author&query=Long Zhang), [Jingren Liu](https://arxiv.org/search/?searchtype=author&query=Jingren Liu), [Jiaqi Yan](https://arxiv.org/search/?searchtype=author&query=Jiaqi Yan), [Zhanjie Zhang](https://arxiv.org/search/?searchtype=author&query=Zhanjie Zhang), [Jiahao Zheng](https://arxiv.org/search/?searchtype=author&query=Jiahao Zheng), [Xun Yang](https://arxiv.org/search/?searchtype=author&query=Xun Yang), [Dapeng Wu](https://arxiv.org/search/?searchtype=author&query=Dapeng Wu), [Xiangyu Chen](https://arxiv.org/search/?searchtype=author&query=Xiangyu Chen), [Xuelong Li](https://arxiv.org/search/?searchtype=author&query=Xuelong Li)
作者：王云，张龙，刘景仁，闫佳琦，张展杰，郑家豪，杨勋，吴大鹏，陈翔宇，李雪龙
...
**Publish**: 2025-08-13 04:33:07 UTC
发布日期：2025-08-13 04:33:07 UTC

## [#78](https://arxiv.org/abs/2508.09473) [NeuronTune: Fine-Grained Neuron Modulation for Balanced Safety-Utility Alignment in LLMs](https://papers.cool/arxiv/2508.09473)  #78 NeuronTune：用于在 LLMs 中实现安全性与效用平衡对齐的细粒度神经元调节

**Authors**: [Birong Pan](https://arxiv.org/search/?searchtype=author&query=Birong Pan), [Mayi Xu](https://arxiv.org/search/?searchtype=author&query=Mayi Xu), [Qiankun Pi](https://arxiv.org/search/?searchtype=author&query=Qiankun Pi), [Jianhao Chen](https://arxiv.org/search/?searchtype=author&query=Jianhao Chen), [Yuanyuan Zhu](https://arxiv.org/search/?searchtype=author&query=Yuanyuan Zhu), [Ming Zhong](https://arxiv.org/search/?searchtype=author&query=Ming Zhong), [Tieyun Qian](https://arxiv.org/search/?searchtype=author&query=Tieyun Qian)
作者：潘碧荣、徐马逸、皮千坤、陈建浩、朱媛媛、钟明、钱铁云
...
## [#79](https://arxiv.org/abs/2508.09468) [DeepFeatIoT: Unifying Deep Learned, Randomized, and LLM Features for Enhanced IoT Time Series Sensor Data Classification in Smart Industries](https://papers.cool/arxiv/2508.09468)  #79 DeepFeatIoT：在智能工业中统一深度学习、随机化与 LLM 特征以增强物联网时间序列传感器数据分类 [PDF ] [Copy] [Kimi ] [REL]

**Authors**: [Muhammad Sakib Khan Inan](https://arxiv.org/search/?searchtype=author&query=Muhammad Sakib Khan Inan), [Kewen Liao](https://arxiv.org/search/?searchtype=author&query=Kewen Liao)
...
**Publish**: 2025-08-13 03:47:33 UTC
发布：2025-08-13 03:47:33 UTC

## [#80](https://arxiv.org/abs/2508.09461) [Gen-AFFECT: Generation of Avatar Fine-grained Facial Expressions with Consistent identiTy](https://papers.cool/arxiv/2508.09461)  #80 Gen-AFFECT：生成具有一致身份的细粒度头像面部表情 [PDF 1 ] [Copy] [Kimi ] [REL]

**Authors**: [Hao Yu](https://arxiv.org/search/?searchtype=author&query=Hao Yu), [Rupayan Mallick](https://arxiv.org/search/?searchtype=author&query=Rupayan Mallick), [Margrit Betke](https://arxiv.org/search/?searchtype=author&query=Margrit Betke), [Sarah Adel Bargal](https://arxiv.org/search/?searchtype=author&query=Sarah Adel Bargal)
...
**Publish**: 2025-08-13 03:35:28 UTC
发布：2025-08-13 03:35:28 协调世界时 (UTC)

## [#82](https://arxiv.org/abs/2508.09458) [Hallucination vs interpretation: rethinking accuracy and precision in AI-assisted data extraction for knowledge synthesis](https://papers.cool/arxiv/2508.09458)  #82 幻觉与解读：重新思考人工智能辅助数据提取在知识综合中的准确性与精确性

**Authors**: [Xi Long](https://arxiv.org/search/?searchtype=author&query=Xi Long), [Christy Boscardin](https://arxiv.org/search/?searchtype=author&query=Christy Boscardin), [Lauren A. Maggio](https://arxiv.org/search/?searchtype=author&query=Lauren A. Maggio), [Joseph A. Costello](https://arxiv.org/search/?searchtype=author&query=Joseph A. Costello), [Ralph Gonzales](https://arxiv.org/search/?searchtype=author&query=Ralph Gonzales), [Rasmyah Hammoudeh](https://arxiv.org/search/?searchtype=author&query=Rasmyah Hammoudeh), [Ki Lai](https://arxiv.org/search/?searchtype=author&query=Ki Lai), [Yoon Soo Park](https://arxiv.org/search/?searchtype=author&query=Yoon Soo Park), [Brian C. Gin](https://arxiv.org/search/?searchtype=author&query=Brian C. Gin)
...
**Subjects**: [Human-Computer Interaction](https://papers.cool/arxiv/cs.HC), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Emerging Technologies](https://papers.cool/arxiv/cs.ET)
主题：人机交互，人工智能，新兴技术

**Publish**: 2025-08-13 03:33:30 UTC
发布：2025-08-13 03:33:30 UTC

## [#83](https://arxiv.org/abs/2508.09451) [A Unified Contrastive-Generative Framework for Time Series Classification](https://papers.cool/arxiv/2508.09451)  #83 一个用于时间序列分类的统一对比-生成框架

**Authors**: [Ziyu Liu](https://arxiv.org/search/?searchtype=author&query=Ziyu Liu), [Azadeh Alavi](https://arxiv.org/search/?searchtype=author&query=Azadeh Alavi), [Minyi Li](https://arxiv.org/search/?searchtype=author&query=Minyi Li), [Xiang Zhang](https://arxiv.org/search/?searchtype=author&query=Xiang Zhang)
...
**Publish**: 2025-08-13 03:09:14 UTC
发布：2025-08-13 03:09:14 UTC

## [#84](https://arxiv.org/abs/2508.09442) [Shadow in the Cache: Unveiling and Mitigating Privacy Risks of KV-cache in LLM Inference](https://papers.cool/arxiv/2508.09442)  #84 缓存中的影子：揭示并缓解 LLM 推理中 KV 缓存的隐私风险

**Authors**: [Zhifan Luo](https://arxiv.org/search/?searchtype=author&query=Zhifan Luo), [Shuo Shao](https://arxiv.org/search/?searchtype=author&query=Shuo Shao), [Su Zhang](https://arxiv.org/search/?searchtype=author&query=Su Zhang), [Lijing Zhou](https://arxiv.org/search/?searchtype=author&query=Lijing Zhou), [Yuke Hu](https://arxiv.org/search/?searchtype=author&query=Yuke Hu), [Chenxu Zhao](https://arxiv.org/search/?searchtype=author&query=Chenxu Zhao), [Zhihao Liu](https://arxiv.org/search/?searchtype=author&query=Zhihao Liu), [Zhan Qin](https://arxiv.org/search/?searchtype=author&query=Zhan Qin)
作者：罗志凡、邵硕、张苏、周丽婧、胡语柯、赵晨旭、刘志豪、秦展
...
## [#85](https://arxiv.org/abs/2508.09428) [What-Meets-Where: Unified Learning of Action and Contact Localization in a New Dataset](https://papers.cool/arxiv/2508.09428)  #85 What-Meets-Where：在新数据集中对动作与接触定位的统一学习
...
**Publish**: 2025-08-13 02:06:33 UTC
发布：2025-08-13 02:06:33 UTC

## [#86](https://arxiv.org/abs/2508.09427) [Implicit Hypergraph Neural Networks: A Stable Framework for Higher-Order Relational Learning with Provable Guarantees](https://papers.cool/arxiv/2508.09427)  #86 隐式超图神经网络：具有可证明保证的高阶关系学习的稳定框架

**Authors**: [Xiaoyu Li](https://arxiv.org/search/?searchtype=author&query=Xiaoyu Li), [Guangyu Tang](https://arxiv.org/search/?searchtype=author&query=Guangyu Tang), [Jiaojiao Jiang](https://arxiv.org/search/?searchtype=author&query=Jiaojiao Jiang)
作者：李晓宇，唐光宇，蒋娇娇
...
**Publish**: 2025-08-13 02:06:29 UTC
发布：2025-08-13 02:06:29 UTC

## [#87](https://arxiv.org/abs/2508.09418) [Domain-Generalization to Improve Learning in Meta-Learning Algorithms](https://papers.cool/arxiv/2508.09418)  #87 领域泛化以改进元学习算法中的学习

**Authors**: [Usman Anjum](https://arxiv.org/search/?searchtype=author&query=Usman Anjum), [Chris Stockman](https://arxiv.org/search/?searchtype=author&query=Chris Stockman), [Cat Luong](https://arxiv.org/search/?searchtype=author&query=Cat Luong), [Justin Zhan](https://arxiv.org/search/?searchtype=author&query=Justin Zhan)
...
本文提出了领域泛化的锐度感知最小化模型无关元学习（DGS-MAML），这是一种新颖的元学习算法，旨在在训练数据有限的情况下实现跨任务泛化。DGS-MAML 在双层优化框架中将梯度匹配与锐度感知最小化相结合，以增强模型的适应性和鲁棒性。我们通过 PAC-Bayes 理论分析和收敛性保证来支持该方法。基准数据集上的实验结果表明，DGS-MAML 在准确性和泛化能力方面优于现有方法。所提出的方法对于需要少样本学习和快速适应的场景尤为有用，源代码已在 GitHub 上公开可用。

**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：机器学习，人工智能

**Publish**: 2025-08-13 01:30:11 UTC
发布时间：2025-08-13 01:30:11 UTC

## [#88](https://arxiv.org/abs/2508.09415) [RampNet: A Two-Stage Pipeline for Bootstrapping Curb Ramp Detection in Streetscape Images from Open Government Metadata](https://papers.cool/arxiv/2508.09415)  #88 RampNet：一种用于从开放政府元数据中引导街景图像人行道坡道检测的两阶段流水线

**Authors**: [John S. O'Meara](https://arxiv.org/search/?searchtype=author&query=John S. O'Meara), [Jared Hwang](https://arxiv.org/search/?searchtype=author&query=Jared Hwang), [Zeyu Wang](https://arxiv.org/search/?searchtype=author&query=Zeyu Wang), [Michael Saugstad](https://arxiv.org/search/?searchtype=author&query=Michael Saugstad), [Jon E. Froehlich](https://arxiv.org/search/?searchtype=author&query=Jon E. Froehlich)
...
**Publish**: 2025-08-13 01:22:48 UTC
发布：2025-08-13 01:22:48 协调世界时 (UTC)

## [#89](https://arxiv.org/abs/2508.09385) [Understanding Dementia Speech Alignment with Diffusion-Based Image Generation](https://papers.cool/arxiv/2508.09385)  #89 理解痴呆症语音与基于扩散的图像生成的对齐

**Authors**: [Mansi](https://arxiv.org/search/?searchtype=author&query=Mansi), [Anastasios Lepipas](https://arxiv.org/search/?searchtype=author&query=Anastasios Lepipas), [Dominika Woszczyk](https://arxiv.org/search/?searchtype=author&query=Dominika Woszczyk), [Yiying Guan](https://arxiv.org/search/?searchtype=author&query=Yiying Guan), [Soteris Demetriou](https://arxiv.org/search/?searchtype=author&query=Soteris Demetriou)
...
文本到图像模型能够根据自然语言描述生成高度逼真的图像，数以百万计的用户使用它们在线创建并分享图像。尽管人们期望此类模型能够在相同的潜在空间中对齐输入文本和生成的图像，但对于这种对齐是否可能在病理性言语与生成图像之间实现的研究甚少。在本工作中，我们考察了此类模型将与痴呆相关的言语信息与生成图像对齐的能力，并开发了用于解释这种对齐的方法。令人惊讶的是，我们发现仅凭生成的图像就能进行痴呆检测，在 ADReSS 数据集上达到了 75%的准确率。随后我们利用可解释性方法展示了语言的哪些部分对该检测有贡献。

**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：机器学习，人工智能

**Publish**: 2025-08-12 23:00:36 UTC
发布：2025-08-12 23:00:36 UTC

## [#90](https://arxiv.org/abs/2508.09383) [X-UniMotion: Animating Human Images with Expressive, Unified and Identity-Agnostic Motion Latents](https://papers.cool/arxiv/2508.09383)  #90 X-UniMotion：使用富有表现力、统一且与身份无关的运动潜变量为人体图像赋予动画

**Authors**: [Guoxian Song](https://arxiv.org/search/?searchtype=author&query=Guoxian Song), [Hongyi Xu](https://arxiv.org/search/?searchtype=author&query=Hongyi Xu), [Xiaochen Zhao](https://arxiv.org/search/?searchtype=author&query=Xiaochen Zhao), [You Xie](https://arxiv.org/search/?searchtype=author&query=You Xie), [Tianpei Gu](https://arxiv.org/search/?searchtype=author&query=Tianpei Gu), [Zenan Li](https://arxiv.org/search/?searchtype=author&query=Zenan Li), [Chenxu Zhang](https://arxiv.org/search/?searchtype=author&query=Chenxu Zhang), [Linjie Luo](https://arxiv.org/search/?searchtype=author&query=Linjie Luo)
作者：宋国贤、许鸿毅、赵晓晨、谢宥、顾天培、李泽南、张晨旭、罗林杰
...
**Publish**: 2025-08-12 22:47:20 UTC
发布：2025-08-12 22:47:20 UTC

## [#91](https://arxiv.org/abs/2508.09381) [What Can We Learn from Inter-Annotator Variability in Skin Lesion Segmentation?](https://papers.cool/arxiv/2508.09381)  #91 我们可以从皮损分割中的标注者间差异学到什么？

**Authors**: [Kumar Abhishek](https://arxiv.org/search/?searchtype=author&query=Kumar Abhishek), [Jeremy Kawahara](https://arxiv.org/search/?searchtype=author&query=Jeremy Kawahara), [Ghassan Hamarneh](https://arxiv.org/search/?searchtype=author&query=Ghassan Hamarneh)
...
**Publish**: 2025-08-12 22:37:56 UTC
发布：2025-08-12 22:37:56 UTC

## [#92](https://arxiv.org/abs/2508.09378) [APIO: Automatic Prompt Induction and Optimization for Grammatical Error Correction and Text Simplification](https://papers.cool/arxiv/2508.09378)  #92 APIO：用于语法错误修正和文本简化的自动提示引导与优化

**Authors**: [Artem Chernodub](https://arxiv.org/search/?searchtype=author&query=Artem Chernodub), [Aman Saini](https://arxiv.org/search/?searchtype=author&query=Aman Saini), [Yejin Huh](https://arxiv.org/search/?searchtype=author&query=Yejin Huh), [Vivek Kulkarni](https://arxiv.org/search/?searchtype=author&query=Vivek Kulkarni), [Vipul Raheja](https://arxiv.org/search/?searchtype=author&query=Vipul Raheja)
作者：Artem Chernodub、Aman Saini、Yejin Huh、Vivek Kulkarni、Vipul Raheja

Recent advancements in large language models (LLMs) have enabled a wide range of natural language processing (NLP) tasks to be performed through simple prompt-based interactions. Consequently, several approaches have been proposed to engineer prompts that most effectively enable LLMs to perform a given task (e.g., chain-of-thought prompting). In settings with a well-defined metric to optimize model performance, automatic prompt optimization (APO) methods have been developed to refine a seed prompt. Advancing this line of research, we propose APIO, a simple but effective prompt induction and optimization approach for the tasks of Grammatical Error Correction (GEC) and Text Simplification, without relying on manually specified seed prompts. APIO achieves a new state-of-the-art performance for purely LLM-based prompting methods on these tasks. We make our data, code, prompts, and outputs publicly available.
近年来，大型语言模型（LLMs）的进展使得通过简单的基于提示的交互即可执行广泛的自然语言处理（NLP）任务成为可能。因此，已经提出了多种方法来设计提示，以最有效地使 LLMs 执行给定任务（例如，链式思维提示）。在具有明确定义的评估指标以优化模型性能的设置中，已经开发出自动提示优化（APO）方法来改进初始提示。沿着这一路线推进，我们提出了 APIO，一种简单但有效的提示引导与优化方法，适用于语法错误修正（GEC）和文本简化任务，并且不依赖手工指定的种子提示。APIO 在这些任务上为纯基于 LLM 的提示方法取得了新的最先进性能。我们公开提供了我们的数据、代码、提示和输出。
...
## [#93](https://arxiv.org/abs/2508.09372) [A Signer-Invariant Conformer and Multi-Scale Fusion Transformer for Continuous Sign Language Recognition](https://papers.cool/arxiv/2508.09372)  #93 一种对示者不变的 Conformer 与多尺度融合 Transformer 用于连续手语识别
...
**Subjects**: [Computer Vision and Pattern Recognition](https://papers.cool/arxiv/cs.CV), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Information Retrieval](https://papers.cool/arxiv/cs.IR), [Machine Learning](https://papers.cool/arxiv/cs.LG)

**Publish**: 2025-08-12 21:59:53 UTC
发布时间：2025-08-12 21:59:53 协调世界时 (UTC)

## [#94](https://arxiv.org/abs/2508.09362) [FusionEnsemble-Net: An Attention-Based Ensemble of Spatiotemporal Networks for Multimodal Sign Language Recognition](https://papers.cool/arxiv/2508.09362)  #94 FusionEnsemble-Net：一种基于注意力的时空网络集成用于多模态手语识别 [PDF 1 ] [Copy] [Kimi ] [REL]
...
**Publish**: 2025-08-12 21:44:23 UTC
发布时间：2025-08-12 21:44:23 UTC

## [#95](https://arxiv.org/abs/2508.09349) [The Human-AI Hybrid Delphi Model: A Structured Framework for Context-Rich, Expert Consensus in Complex Domains](https://papers.cool/arxiv/2508.09349)  #95 人类—人工智能混合德尔菲模型：用于复杂领域中背景丰富的专家共识的结构化框架
...
## [#96](https://arxiv.org/abs/2508.09340) [Collective dynamics of strategic classification](https://papers.cool/arxiv/2508.09340)  #96 战略分类的集体动力学

**Authors**: [Marta C. Couto](https://arxiv.org/search/?searchtype=author&query=Marta C. Couto), [Flavia Barsotti](https://arxiv.org/search/?searchtype=author&query=Flavia Barsotti), [Fernando P. Santos](https://arxiv.org/search/?searchtype=author&query=Fernando P. Santos)
...
**Subjects**: [Computer Science and Game Theory](https://papers.cool/arxiv/cs.GT), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Theoretical Economics](https://papers.cool/arxiv/econ.TH)
主题：计算机科学与博弈论、人工智能、理论经济学

**Publish**: 2025-08-12 20:57:17 UTC
发布日期：2025-08-12 20:57:17 UTC

## [#97](https://arxiv.org/abs/2508.09334) [RicciFlowRec: A Geometric Root Cause Recommender Using Ricci Curvature on Financial Graphs](https://papers.cool/arxiv/2508.09334)  #97 RicciFlowRec：一种在金融图上使用里奇曲率的几何根因推荐器

**Authors**: [Zhongtian Sun](https://arxiv.org/search/?searchtype=author&query=Zhongtian Sun), [Anoushka Harit](https://arxiv.org/search/?searchtype=author&query=Anoushka Harit)
作者：孙中天，Anoushka Harit
...
我们提出了 RicciFlowRec，一种几何推荐框架，通过离散里奇曲率和里奇流在动态金融图上进行根源归因。通过对股票、宏观经济指标和新闻之间不断演化的相互作用建模，我们使用离散里奇曲率量化局部压力，并通过里奇流追踪冲击传播。曲率梯度揭示因果子结构，为结构性风险感知的排序函数提供信息。在以 FinBERT 为基础的情感分析下对 S&P 500 数据的初步结果显示，在合成扰动下模型的稳健性和可解释性有所提升。该项正在进行的工作支持基于曲率的归因和早期风险感知排序，未来计划用于组合优化和收益预测。据我们所知，RicciFlowRec 是首个在金融决策支持中应用几何流推理的推荐系统。

**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Information Retrieval](https://papers.cool/arxiv/cs.IR)
主题：机器学习、人工智能、信息检索

**Publish**: 2025-08-12 20:45:02 UTC
发布时间：2025-08-12 20:45:02 UTC

## [#98](https://arxiv.org/abs/2508.09330) [Synaptic Pruning: A Biological Inspiration for Deep Learning Regularization](https://papers.cool/arxiv/2508.09330)  #98 突触修剪：对深度学习正则化的生物学启发
...
**Publish**: 2025-08-12 20:36:00 UTC
发布：2025-08-12 20:36:00 UTC

## [#99](https://arxiv.org/abs/2508.09325) [SegDAC: Segmentation-Driven Actor-Critic for Visual Reinforcement Learning](https://papers.cool/arxiv/2508.09325)  #99 SegDAC：面向视觉强化学习的分割驱动 Actor-Critic

**Authors**: [Alexandre Brown](https://arxiv.org/search/?searchtype=author&query=Alexandre Brown), [Glen Berseth](https://arxiv.org/search/?searchtype=author&query=Glen Berseth)
...
**Publish**: 2025-08-12 20:16:54 UTC
发布时间：2025-08-12 20:16:54 UTC

## [#100](https://arxiv.org/abs/2508.09324) [TEN: Table Explicitization, Neurosymbolically](https://papers.cool/arxiv/2508.09324)  #100 十：表格显式化，神经符号方法
...
## [#101](https://arxiv.org/abs/2508.09323) [Leveraging Large Language Models for Rare Disease Named Entity Recognition](https://papers.cool/arxiv/2508.09323)  #101 利用大型语言模型进行罕见病命名实体识别
...
## [#102](https://arxiv.org/abs/2508.09320) [Exact Verification of Graph Neural Networks with Incremental Constraint Solving](https://papers.cool/arxiv/2508.09320)  #102 使用增量约束求解对图神经网络进行精确验证

**Authors**: [Minghao Liu](https://arxiv.org/search/?searchtype=author&query=Minghao Liu), [Chia-Hsuan Lu](https://arxiv.org/search/?searchtype=author&query=Chia-Hsuan Lu), [Marta Kwiatkowska](https://arxiv.org/search/?searchtype=author&query=Marta Kwiatkowska)
...
**Publish**: 2025-08-12 20:10:31 UTC
发布：2025-08-12 20:10:31 UTC

## [#103](https://arxiv.org/abs/2508.09318) [TPTP World Infrastructure for Non-classical Logics](https://papers.cool/arxiv/2508.09318)  #103 TPTP 非经典逻辑世界基础设施

**Authors**: [Alexander Steen](https://arxiv.org/search/?searchtype=author&query=Alexander Steen), [Geoff Sutcliffe](https://arxiv.org/search/?searchtype=author&query=Geoff Sutcliffe)
...
TPTP 世界是支持自动定理证明（ATP）系统研究、开发和部署的成熟基础设施。TPTP 世界支持一系列经典逻辑，并自 v9.0.0 版本起支持非经典逻辑。本文提供了一个自包含的、全面的关于用于非经典逻辑 ATP 的 TPTP 世界基础设施的概述：非经典语言扩展、问题与解决方案以及工具支持。文中详述了该基础设施在带量化的标准多模态逻辑中的具体使用。

**Subjects**: [Logic in Computer Science](https://papers.cool/arxiv/cs.LO), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：计算机科学中的逻辑、人工智能

**Publish**: 2025-08-12 20:05:52 UTC
发布时间：2025-08-12 20:05:52 UTC

## [#104](https://arxiv.org/abs/2508.09303) [ParallelSearch: Train your LLMs to Decompose Query and Search Sub-queries in Parallel with Reinforcement Learning](https://papers.cool/arxiv/2508.09303)  #104 ParallelSearch：使用强化学习训练你的 LLMs 将查询分解并并行搜索子查询 [PDF 3 ] [Copy] [Kimi 1 ] [REL]
...
## [#105](https://arxiv.org/abs/2508.09299) [Decentralized Weather Forecasting via Distributed Machine Learning and Blockchain-Based Model Validation](https://papers.cool/arxiv/2508.09299)  #105 去中心化天气预报：通过分布式机器学习与基于区块链的模型验证 [PDF ] [Copy] [Kimi ] [REL]

**Authors**: [Rilwan Umar](https://arxiv.org/search/?searchtype=author&query=Rilwan Umar), [Aydin Abadi](https://arxiv.org/search/?searchtype=author&query=Aydin Abadi), [Basil Aldali](https://arxiv.org/search/?searchtype=author&query=Basil Aldali), [Benito Vincent](https://arxiv.org/search/?searchtype=author&query=Benito Vincent), [Elliot A. J. Hurley](https://arxiv.org/search/?searchtype=author&query=Elliot A. J. Hurley), [Hotoon Aljazaeri](https://arxiv.org/search/?searchtype=author&query=Hotoon Aljazaeri), [Jamie Hedley-Cook](https://arxiv.org/search/?searchtype=author&query=Jamie Hedley-Cook), [Jamie-Lee Bell](https://arxiv.org/search/?searchtype=author&query=Jamie-Lee Bell), [Lambert Uwuigbusun](https://arxiv.org/search/?searchtype=author&query=Lambert Uwuigbusun), [Mujeeb Ahmed](https://arxiv.org/search/?searchtype=author&query=Mujeeb Ahmed), [Shishir Nagaraja](https://arxiv.org/search/?searchtype=author&query=Shishir Nagaraja), [Suleiman Sabo](https://arxiv.org/search/?searchtype=author&query=Suleiman Sabo), [Weaam Alrbeiqi](https://arxiv.org/search/?searchtype=author&query=Weaam Alrbeiqi)
...
**Publish**: 2025-08-12 19:20:43 UTC
发布：2025-08-12 19:20:43 UTC

## [#107](https://arxiv.org/abs/2508.09294) [Fake-Mamba: Real-Time Speech Deepfake Detection Using Bidirectional Mamba as Self-Attention&#39;s Alternative](https://papers.cool/arxiv/2508.09294)  #107 假曼巴：使用双向曼巴作为自注意力替代的实时语音深度伪造检测
...
**Publish**: 2025-08-12 19:14:37 UTC
发布：2025-08-12 19:14:37 UTC

## [#109](https://arxiv.org/abs/2508.09288) [Can AI Keep a Secret? Contextual Integrity Verification: A Provable Security Architecture for LLMs](https://papers.cool/arxiv/2508.09288)  #109 人工智能能保守秘密吗？情境完整性验证：一种面向 LLMs 的可证明安全架构
...
## [#110](https://arxiv.org/abs/2508.09264) [Detection of Odor Presence via Deep Neural Networks](https://papers.cool/arxiv/2508.09264)  #110 通过深度神经网络检测气味存在

**Authors**: [Matin Hassanloo](https://arxiv.org/search/?searchtype=author&query=Matin Hassanloo), [Ali Zareh](https://arxiv.org/search/?searchtype=author&query=Ali Zareh), [Mehmet Kemal Özdemir](https://arxiv.org/search/?searchtype=author&query=Mehmet Kemal Özdemir)
...
**Publish**: 2025-08-12 18:14:24 UTC
发布时间：2025-08-12 18:14:24 UTC

## [#111](https://arxiv.org/abs/2508.09242) [Cross-BCI, A Cross-BCI-Paradigm Classifica-tion Model Towards Universal BCI Applications](https://papers.cool/arxiv/2508.09242)  #111 Cross-BCI，一种面向通用脑机接口应用的跨 BCI 范式分类模型

**Authors**: [Gaojie Zhou](https://arxiv.org/search/?searchtype=author&query=Gaojie Zhou), [Junhua Li](https://arxiv.org/search/?searchtype=author&query=Junhua Li)
作者：周高杰、李俊华
...
**Subjects**: [Quantitative Methods](https://papers.cool/arxiv/q-bio.QM), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Human-Computer Interaction](https://papers.cool/arxiv/cs.HC)
主题：定量方法、人工智能、人机交互

**Publish**: 2025-08-12 16:04:50 UTC
发布：2025-08-12 16:04:50 UTC

## [#112](https://arxiv.org/abs/2508.09240) [NEFMind: Parameter-Efficient Fine-Tuning of Open-Source LLMs for Telecom APIs Automation](https://papers.cool/arxiv/2508.09240)  #112 NEFMind：面向电信 API 自动化的开源 LLMs 参数高效微调
...
**Subjects**: [Multimedia](https://papers.cool/arxiv/cs.MM), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Databases](https://papers.cool/arxiv/cs.DB)
主题：多媒体、人工智能、数据库

**Publish**: 2025-08-12 08:33:40 UTC
发表时间：2025-08-12 08:33:40 UTC

## [#115](https://arxiv.org/abs/2508.09231) [Beyond Technocratic XAI: The Who, What &amp; How in Explanation Design](https://papers.cool/arxiv/2508.09231)  #115 超越技术官僚化的可解释人工智能：解释设计中的“谁、什么与如何”
...
可解释人工智能（XAI）领域提供了多种使复杂模型可解释的技术。然而，在实践中，生成有意义的解释是一个依赖情境的任务，需要有意的设计选择以确保可访问性和透明度。本文将解释重新框定为一种情境化的设计过程——这一方法对参与构建和部署可解释系统的从业者尤为相关。借鉴既有研究和设计思维的原则，我们提出了一个用于 XAI 解释设计的三部分框架：询问谁需要解释、他们需要解释什么以及应如何传达该解释。我们还强调了伦理考量的必要性，包括认识上的不平等风险、加强社会不平等以及掩盖问责与治理的问题。通过将解释视为一种社会技术的设计过程，该框架鼓励一种情境感知的 XAI 方法，支持有效沟通并促进具有伦理责任感的解释开发。

**Subjects**: [Computers and Society](https://papers.cool/arxiv/cs.CY), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Human-Computer Interaction](https://papers.cool/arxiv/cs.HC)
主题：计算机与社会、人工智能、人机交互

**Publish**: 2025-08-12 08:17:26 UTC
发布：2025-08-12 08:17:26 UTC

## [#116](https://arxiv.org/abs/2508.09230) [Cowpox: Towards the Immunity of VLM-based Multi-Agent Systems](https://papers.cool/arxiv/2508.09230)  #116 牛痘：迈向基于 VLM 的多智能体系统的免疫性

**Authors**: [Yutong Wu](https://arxiv.org/search/?searchtype=author&query=Yutong Wu), [Jie Zhang](https://arxiv.org/search/?searchtype=author&query=Jie Zhang), [Yiming Li](https://arxiv.org/search/?searchtype=author&query=Yiming Li), [Chao Zhang](https://arxiv.org/search/?searchtype=author&query=Chao Zhang), [Qing Guo](https://arxiv.org/search/?searchtype=author&query=Qing Guo), [Nils Lukas](https://arxiv.org/search/?searchtype=author&query=Nils Lukas), [Tianwei Zhang](https://arxiv.org/search/?searchtype=author&query=Tianwei Zhang)
作者：吴雨彤，张杰，李一鸣，张超，郭清，Nils Lukas，张天威
...
## [#117](https://arxiv.org/abs/2508.09229) [Cluster Topology-Driven Placement of Experts Reduces Network Traffic in MoE Inference](https://papers.cool/arxiv/2508.09229)  #117 基于集群拓扑的专家分配在 MoE 推理中降低了网络流量

**Authors**: [Danil Sivtsov](https://arxiv.org/search/?searchtype=author&query=Danil Sivtsov), [Aleksandr Katrutsa](https://arxiv.org/search/?searchtype=author&query=Aleksandr Katrutsa), [Ivan Oseledets](https://arxiv.org/search/?searchtype=author&query=Ivan Oseledets)
...
**Subjects**: [Networking and Internet Architecture](https://papers.cool/arxiv/cs.NI), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Distributed, Parallel, and Cluster Computing](https://papers.cool/arxiv/cs.DC)
主题：网络与互联网体系结构、人工智能、分布式、并行与集群计算

**Publish**: 2025-08-12 07:08:48 UTC
发布：2025-08-12 07:08:48 UTC

## [#118](https://arxiv.org/abs/2508.09227) [GSMT: Graph Fusion and Spatiotemporal TaskCorrection for Multi-Bus Trajectory Prediction](https://papers.cool/arxiv/2508.09227)  #118 GSMT：用于多公交轨迹预测的图融合与时空任务校正（Graph Fusion and Spatiotemporal TaskCorrection）

**Authors**: [Fan Ding](https://arxiv.org/search/?searchtype=author&query=Fan Ding), [Hwa Hui Tew](https://arxiv.org/search/?searchtype=author&query=Hwa Hui Tew), [Junn Yong Loo](https://arxiv.org/search/?searchtype=author&query=Junn Yong Loo), [Susilawati](https://arxiv.org/search/?searchtype=author&query=Susilawati), [LiTong Liu](https://arxiv.org/search/?searchtype=author&query=LiTong Liu), [Fang Yu Leong](https://arxiv.org/search/?searchtype=author&query=Fang Yu Leong), [Xuewen Luo](https://arxiv.org/search/?searchtype=author&query=Xuewen Luo), [Kar Keong Chin](https://arxiv.org/search/?searchtype=author&query=Kar Keong Chin), [Jia Jun Gan](https://arxiv.org/search/?searchtype=author&query=Jia Jun Gan)
作者：丁凡、廖华辉（Hwa Hui Tew）、卢俊勇（Junn Yong Loo）、Susilawati、刘利通（LiTong Liu）、梁芳玉（Fang Yu Leong）、罗学文（Xuewen Luo）、陈家强（Kar Keong Chin）、颜家俊（Jia Jun Gan）
...
学科：机器学习、人工智能、计算工程、金融与科学

**Publish**: 2025-08-12 06:54:26 UTC
发表：2025-08-12 06:54:26 UTC

## [#119](https://arxiv.org/abs/2508.09225) [AMRG: Extend Vision Language Models for Automatic Mammography Report Generation](https://papers.cool/arxiv/2508.09225)  #119 AMRG：扩展视觉语言模型以实现自动化乳腺 X 线报告生成

**Authors**: [Nak-Jun Sung](https://arxiv.org/search/?searchtype=author&query=Nak-Jun Sung), [Donghyun Lee](https://arxiv.org/search/?searchtype=author&query=Donghyun Lee), [Bo Hwa Choi](https://arxiv.org/search/?searchtype=author&query=Bo Hwa Choi), [Chae Jung Park](https://arxiv.org/search/?searchtype=author&query=Chae Jung Park)
...
## [#120](https://arxiv.org/abs/2508.09224) [From Hard Refusals to Safe-Completions: Toward Output-Centric Safety Training](https://papers.cool/arxiv/2508.09224)  #120 从强拒绝到安全完成：走向以输出为中心的安全训练
...
## [#121](https://arxiv.org/abs/2508.09223) [Hierarchical Adaptive networks with Task vectors for Test-Time Adaptation](https://papers.cool/arxiv/2508.09223)  #121 层次自适应网络与任务向量用于测试时自适应

**Authors**: [Sameer Ambekar](https://arxiv.org/search/?searchtype=author&query=Sameer Ambekar), [Daniel M. Lang](https://arxiv.org/search/?searchtype=author&query=Daniel M. Lang), [Julia A. Schnabel](https://arxiv.org/search/?searchtype=author&query=Julia A. Schnabel)
...
**Publish**: 2025-08-11 19:10:34 UTC
发布日期：2025-08-11 19:10:34 UTC

## [#123](https://arxiv.org/abs/2508.09219) [Understanding Ethical Practices in AI: Insights from a Cross-Role, Cross-Region Survey of AI Development Teams](https://papers.cool/arxiv/2508.09219)  #123 理解人工智能的伦理实践：来自跨角色、跨地域 AI 开发团队调查的见解

**Authors**: [Wilder Baldwin](https://arxiv.org/search/?searchtype=author&query=Wilder Baldwin), [Sepideh Ghanavati](https://arxiv.org/search/?searchtype=author&query=Sepideh Ghanavati), [Manuel Woersdoerfer](https://arxiv.org/search/?searchtype=author&query=Manuel Woersdoerfer)
...
**Subjects**: [Computers and Society](https://papers.cool/arxiv/cs.CY), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Human-Computer Interaction](https://papers.cool/arxiv/cs.HC), [Software Engineering](https://papers.cool/arxiv/cs.SE)
主题：计算机与社会、人工智能、人机交互、软件工程

**Publish**: 2025-08-11 19:07:20 UTC
发布：2025-08-11 19:07:20 UTC

## [#124](https://arxiv.org/abs/2508.09218) [Towards Effective MLLM Jailbreaking Through Balanced On-Topicness and OOD-Intensity](https://papers.cool/arxiv/2508.09218)  #124 朝着有效的多模态大模型越狱：在相关性与域外强度间实现平衡

**Authors**: [Zuoou Li](https://arxiv.org/search/?searchtype=author&query=Zuoou Li), [Weitong Zhang](https://arxiv.org/search/?searchtype=author&query=Weitong Zhang), [Jingyuan Wang](https://arxiv.org/search/?searchtype=author&query=Jingyuan Wang), [Shuyuan Zhang](https://arxiv.org/search/?searchtype=author&query=Shuyuan Zhang), [Wenjia Bai](https://arxiv.org/search/?searchtype=author&query=Wenjia Bai), [Bernhard Kainz](https://arxiv.org/search/?searchtype=author&query=Bernhard Kainz), [Mengyun Qiao](https://arxiv.org/search/?searchtype=author&query=Mengyun Qiao)
...
**Publish**: 2025-08-11 18:57:55 UTC
发布时间：2025-08-11 18:57:55 UTC

## [#125](https://arxiv.org/abs/2508.09215) [Real-time deep learning phase imaging flow cytometer reveals blood cell aggregate biomarkers for haematology diagnostics](https://papers.cool/arxiv/2508.09215)  #125 实时深度学习相位成像流式细胞仪揭示用于血液学诊断的血细胞聚集生物标志物

**Authors**: [Kerem Delikoyun](https://arxiv.org/search/?searchtype=author&query=Kerem Delikoyun), [Qianyu Chen](https://arxiv.org/search/?searchtype=author&query=Qianyu Chen), [Liu Wei](https://arxiv.org/search/?searchtype=author&query=Liu Wei), [Si Ko Myo](https://arxiv.org/search/?searchtype=author&query=Si Ko Myo), [Johannes Krell](https://arxiv.org/search/?searchtype=author&query=Johannes Krell), [Martin Schlegel](https://arxiv.org/search/?searchtype=author&query=Martin Schlegel), [Win Sen Kuan](https://arxiv.org/search/?searchtype=author&query=Win Sen Kuan), [John Tshon Yit Soong](https://arxiv.org/search/?searchtype=author&query=John Tshon Yit Soong), [Gerhard Schneider](https://arxiv.org/search/?searchtype=author&query=Gerhard Schneider), [Clarissa Prazeres da Costa](https://arxiv.org/search/?searchtype=author&query=Clarissa Prazeres da Costa), [Percy A. Knolle](https://arxiv.org/search/?searchtype=author&query=Percy A. Knolle), [Laurent Renia](https://arxiv.org/search/?searchtype=author&query=Laurent Renia), [Matthew Edward Cove](https://arxiv.org/search/?searchtype=author&query=Matthew Edward Cove), [Hwee Kuan Lee](https://arxiv.org/search/?searchtype=author&query=Hwee Kuan Lee), [Klaus Diepold](https://arxiv.org/search/?searchtype=author&query=Klaus Diepold), [Oliver Hayden](https://arxiv.org/search/?searchtype=author&query=Oliver Hayden)
...
**Subjects**: [Quantitative Methods](https://papers.cool/arxiv/q-bio.QM), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Computer Vision and Pattern Recognition](https://papers.cool/arxiv/cs.CV), [Machine Learning](https://papers.cool/arxiv/cs.LG), [Image and Video Processing](https://papers.cool/arxiv/eess.IV)
主题：定量方法、人工智能、计算机视觉与模式识别、机器学习、图像与视频处理

**Publish**: 2025-08-11 15:58:12 UTC
发布时间：2025-08-11 15:58:12 UTC

## [#126](https://arxiv.org/abs/2508.09212) [Deep Generative Models for Discrete Genotype Simulation](https://papers.cool/arxiv/2508.09212)  #126 离散基因型模拟的深度生成模型

**Authors**: [Sihan Xie](https://arxiv.org/search/?searchtype=author&query=Sihan Xie), [Thierry Tribout](https://arxiv.org/search/?searchtype=author&query=Thierry Tribout), [Didier Boichard](https://arxiv.org/search/?searchtype=author&query=Didier Boichard), [Blaise Hanczar](https://arxiv.org/search/?searchtype=author&query=Blaise Hanczar), [Julien Chiquet](https://arxiv.org/search/?searchtype=author&query=Julien Chiquet), [Eric Barrey](https://arxiv.org/search/?searchtype=author&query=Eric Barrey)
作者：Sihan Xie、Thierry Tribout、Didier Boichard、Blaise Hanczar、Julien Chiquet、Eric Barrey
...
**Publish**: 2025-08-11 11:56:03 UTC
发布：2025-08-11 11:56:03 UTC

## [#127](https://arxiv.org/abs/2508.09210) [MME-Emotion: A Holistic Evaluation Benchmark for Emotional Intelligence in Multimodal Large Language Models](https://papers.cool/arxiv/2508.09210)  #127 MME-Emotion：用于多模态大型语言模型情感智能的整体评估基准

**Authors**: [Fan Zhang](https://arxiv.org/search/?searchtype=author&query=Fan Zhang), [Zebang Cheng](https://arxiv.org/search/?searchtype=author&query=Zebang Cheng), [Chong Deng](https://arxiv.org/search/?searchtype=author&query=Chong Deng), [Haoxuan Li](https://arxiv.org/search/?searchtype=author&query=Haoxuan Li), [Zheng Lian](https://arxiv.org/search/?searchtype=author&query=Zheng Lian), [Qian Chen](https://arxiv.org/search/?searchtype=author&query=Qian Chen), [Huadai Liu](https://arxiv.org/search/?searchtype=author&query=Huadai Liu), [Wen Wang](https://arxiv.org/search/?searchtype=author&query=Wen Wang), [Yi-Fan Zhang](https://arxiv.org/search/?searchtype=author&query=Yi-Fan Zhang), [Renrui Zhang](https://arxiv.org/search/?searchtype=author&query=Renrui Zhang), [Ziyu Guo](https://arxiv.org/search/?searchtype=author&query=Ziyu Guo), [Zhihong Zhu](https://arxiv.org/search/?searchtype=author&query=Zhihong Zhu), [Hao Wu](https://arxiv.org/search/?searchtype=author&query=Hao Wu), [Haixin Wang](https://arxiv.org/search/?searchtype=author&query=Haixin Wang), [Yefeng Zheng](https://arxiv.org/search/?searchtype=author&query=Yefeng Zheng), [Xiaojiang Peng](https://arxiv.org/search/?searchtype=author&query=Xiaojiang Peng), [Xian Wu](https://arxiv.org/search/?searchtype=author&query=Xian Wu), [Kun Wang](https://arxiv.org/search/?searchtype=author&query=Kun Wang), [Xiangang Li](https://arxiv.org/search/?searchtype=author&query=Xiangang Li), [Jieping Ye](https://arxiv.org/search/?searchtype=author&query=Jieping Ye), [Pheng-Ann Heng](https://arxiv.org/search/?searchtype=author&query=Pheng-Ann Heng)
作者：张帆、程泽邦、邓冲、李浩轩、连征、陈茜、刘怀岱、王文、张一帆、张仁瑞、郭紫雨、朱志宏、吴昊、王海昕、郑野峰、彭晓江、吴仙、王坤、李贤刚、叶劲平、恒炳安
...
**Publish**: 2025-08-11 03:14:55 UTC
发布：2025-08-11 03:14:55 UTC

## [#128](https://arxiv.org/abs/2508.09209) [Quantum-Enhanced Generative Adversarial Networks: Comparative Analysis of Classical and Hybrid Quantum-Classical Generative Adversarial Networks](https://papers.cool/arxiv/2508.09209)  #128 量子增强生成对抗网络：经典与混合量子-经典生成对抗网络的比较分析

**Author**: [Kun Ming Goh](https://arxiv.org/search/?searchtype=author&query=Kun Ming Goh)
作者：Kun Ming Goh
...
**Subjects**: [Quantum Physics](https://papers.cool/arxiv/quant-ph), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Machine Learning](https://papers.cool/arxiv/cs.LG)
主题：量子物理、人工智能、机器学习

**Publish**: 2025-08-10 18:34:53 UTC
发布：2025-08-10 18:34:53 UTC

## [#129](https://arxiv.org/abs/2508.09208) [CoMoE: Collaborative Optimization of Expert Aggregation and Offloading for MoE-based LLMs at Edge](https://papers.cool/arxiv/2508.09208)  #129 CoMoE：面向边缘的基于 MoE 的 LLMs 的专家聚合与卸载协同优化

**Authors**: [Muqing Li](https://arxiv.org/search/?searchtype=author&query=Muqing Li), [Ning Li](https://arxiv.org/search/?searchtype=author&query=Ning Li), [Xin Yuan](https://arxiv.org/search/?searchtype=author&query=Xin Yuan), [Wenchao Xu](https://arxiv.org/search/?searchtype=author&query=Wenchao Xu), [Quan Chen](https://arxiv.org/search/?searchtype=author&query=Quan Chen), [Song Guo](https://arxiv.org/search/?searchtype=author&query=Song Guo), [Haijun Zhang](https://arxiv.org/search/?searchtype=author&query=Haijun Zhang)
作者：李慕清，李宁，袁鑫，许文超，陈全，郭松，张海军
...
**Publish**: 2025-08-09 05:58:29 UTC
发布：2025-08-09 05:58:29 UTC

## [#132](https://arxiv.org/abs/2508.09202) [Personalized Feature Translation for Expression Recognition: An Efficient Source-Free Domain Adaptation Method](https://papers.cool/arxiv/2508.09202)  #132 个性化特征转换用于表情识别：一种高效的无源域自适应方法

**Authors**: [Masoumeh Sharafi](https://arxiv.org/search/?searchtype=author&query=Masoumeh Sharafi), [Soufiane Belharbi](https://arxiv.org/search/?searchtype=author&query=Soufiane Belharbi), [Houssem Ben Salem](https://arxiv.org/search/?searchtype=author&query=Houssem Ben Salem), [Ali Etemad](https://arxiv.org/search/?searchtype=author&query=Ali Etemad), [Alessandro Lameiras Koerich](https://arxiv.org/search/?searchtype=author&query=Alessandro Lameiras Koerich), [Marco Pedersoli](https://arxiv.org/search/?searchtype=author&query=Marco Pedersoli), [Simon Bacon](https://arxiv.org/search/?searchtype=author&query=Simon Bacon), [Eric Granger](https://arxiv.org/search/?searchtype=author&query=Eric Granger)
...
**Publish**: 2025-08-08 20:13:50 UTC
发布：2025-08-08 20:13:50 UTC

## [#133](https://arxiv.org/abs/2508.09201) [Learning to Detect Unknown Jailbreak Attacks in Large Vision-Language Models: A Unified and Accurate Approach](https://papers.cool/arxiv/2508.09201)  #133 学习检测大型视觉-语言模型中的未知越狱攻击：一种统一且准确的方法

**Authors**: [Shuang Liang](https://arxiv.org/search/?searchtype=author&query=Shuang Liang), [Zhihao Xu](https://arxiv.org/search/?searchtype=author&query=Zhihao Xu), [Jialing Tao](https://arxiv.org/search/?searchtype=author&query=Jialing Tao), [Hui Xue](https://arxiv.org/search/?searchtype=author&query=Hui Xue), [Xiting Wang](https://arxiv.org/search/?searchtype=author&query=Xiting Wang)
作者：梁爽、徐志浩、陶佳玲、薛晖、王喜廷
...
发布日期：2025-08-08 16:13:28 UTC

## [#134](https://arxiv.org/abs/2508.09200) [Zero-shot self-supervised learning of single breath-hold magnetic resonance cholangiopancreatography (MRCP) reconstruction](https://papers.cool/arxiv/2508.09200)  #134 零样本自监督单次屏气磁共振胆胰管成像（MRCP）重建

**Authors**: [Jinho Kim](https://arxiv.org/search/?searchtype=author&query=Jinho Kim), [Marcel Dominik Nickel](https://arxiv.org/search/?searchtype=author&query=Marcel Dominik Nickel), [Florian Knoll](https://arxiv.org/search/?searchtype=author&query=Florian Knoll)
...
**Publish**: 2025-08-08 13:59:20 UTC
发布：2025-08-08 13:59:20 UTC

## [#135](https://arxiv.org/abs/2508.09199) [Δ-AttnMask: Attention-Guided Masked Hidden States for Efficient Data Selection and Augmentation](https://papers.cool/arxiv/2508.09199)  #135 Δ -AttnMask：用于高效数据选择与增强的注意力引导掩码隐状态
...
## [#136](https://arxiv.org/abs/2508.09198) [ADT4Coupons: An Innovative Framework for Sequential Coupon Distribution in E-commerce](https://papers.cool/arxiv/2508.09198)  #136 ADT4Coupons：用于电子商务中序列化优惠券分发的创新框架

**Authors**: [Li Kong](https://arxiv.org/search/?searchtype=author&query=Li Kong), [Bingzhe Wang](https://arxiv.org/search/?searchtype=author&query=Bingzhe Wang), [Zhou Chen](https://arxiv.org/search/?searchtype=author&query=Zhou Chen), [Suhan Hu](https://arxiv.org/search/?searchtype=author&query=Suhan Hu), [Yuchao Ma](https://arxiv.org/search/?searchtype=author&query=Yuchao Ma), [Qi Qi](https://arxiv.org/search/?searchtype=author&query=Qi Qi), [Suoyuan Song](https://arxiv.org/search/?searchtype=author&query=Suoyuan Song), [Bicheng Jin](https://arxiv.org/search/?searchtype=author&query=Bicheng Jin)
...
**Publish**: 2025-08-08 13:03:17 UTC
发布日期：2025-08-08 13:03:17 UTC

## [#137](https://arxiv.org/abs/2508.09197) [MX-AI: Agentic Observability and Control Platform for Open and AI-RAN](https://papers.cool/arxiv/2508.09197)  #137 MX-AI：用于开放和 AI-RAN 的自主可观测性与控制平台

**Authors**: [Ilias Chatzistefanidis](https://arxiv.org/search/?searchtype=author&query=Ilias Chatzistefanidis), [Andrea Leone](https://arxiv.org/search/?searchtype=author&query=Andrea Leone), [Ali Yaghoubian](https://arxiv.org/search/?searchtype=author&query=Ali Yaghoubian), [Mikel Irazabal](https://arxiv.org/search/?searchtype=author&query=Mikel Irazabal), [Sehad Nassim](https://arxiv.org/search/?searchtype=author&query=Sehad Nassim), [Lina Bariah](https://arxiv.org/search/?searchtype=author&query=Lina Bariah), [Merouane Debbah](https://arxiv.org/search/?searchtype=author&query=Merouane Debbah), [Navid Nikaein](https://arxiv.org/search/?searchtype=author&query=Navid Nikaein)
...
**Publish**: 2025-08-08 12:15:47 UTC
发布：2025-08-08 12:15:47 UTC

## [#138](https://arxiv.org/abs/2508.09196) [FIVA: Federated Inverse Variance Averaging for Universal CT Segmentation with Uncertainty Estimation](https://papers.cool/arxiv/2508.09196)  #138 FIVA：用于具有不确定性估计的通用 CT 分割的联邦逆方差平均

**Authors**: [Asim Ukaye](https://arxiv.org/search/?searchtype=author&query=Asim Ukaye), [Numan Saeed](https://arxiv.org/search/?searchtype=author&query=Numan Saeed), [Karthik Nandakumar](https://arxiv.org/search/?searchtype=author&query=Karthik Nandakumar)
...
**Publish**: 2025-08-08 10:01:16 UTC
发布时间：2025-08-08 10:01:16 UTC

## [#140](https://arxiv.org/abs/2508.09194) [Meta-Learning for Speeding Up Large Model Inference in Decentralized Environments](https://papers.cool/arxiv/2508.09194)  #140 在去中心化环境中通过元学习加速大模型推理

**Authors**: [Yipeng Du](https://arxiv.org/search/?searchtype=author&query=Yipeng Du), [Zihao Wang](https://arxiv.org/search/?searchtype=author&query=Zihao Wang), [Ahmad Farhan](https://arxiv.org/search/?searchtype=author&query=Ahmad Farhan), [Claudio Angione](https://arxiv.org/search/?searchtype=author&query=Claudio Angione), [Harry Yang](https://arxiv.org/search/?searchtype=author&query=Harry Yang), [Fielding Johnston](https://arxiv.org/search/?searchtype=author&query=Fielding Johnston), [James P. Buban](https://arxiv.org/search/?searchtype=author&query=James P. Buban), [Patrick Colangelo](https://arxiv.org/search/?searchtype=author&query=Patrick Colangelo), [Yue Zhao](https://arxiv.org/search/?searchtype=author&query=Yue Zhao), [Yuzhe Yang](https://arxiv.org/search/?searchtype=author&query=Yuzhe Yang)
作者：杜一鹏、王子浩、Ahmad Farhan、Claudio Angione、Harry Yang、Fielding Johnston、James P. Buban、Patrick Colangelo、赵跃、杨宇哲
...
近年来生成模型的进展强调了自然语言作为一种高度表达性且易于访问的模态，在控制内容生成方面的重要性。然而，现有用于程序化内容生成的指令式强化学习（IPCGRL）方法常难以充分利用文本输入的表达丰富性，尤其是在复杂的、多目标指令下，导致可控性受限。为了解决这一问题，我们提出了 MIPCGRL，一种用于指令式内容生成器的多目标表示学习方法，该方法将句子嵌入作为条件。MIPCGRL 通过引入多标签分类和多头回归网络，有效训练了一个多目标嵌入空间。实验结果表明，所提方法在多目标指令下可控性提升最多可达 13.8%。处理复杂指令的能力使得内容生成更加富有表达性和灵活性。

**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI)
主题：机器学习，人工智能

**Publish**: 2025-08-08 09:41:42 UTC
发布：2025-08-08 09:41:42 UTC

## [#142](https://arxiv.org/abs/2508.09192) [Diffusion LLMs Can Do Faster-Than-AR Inference via Discrete Diffusion Forcing](https://papers.cool/arxiv/2508.09192)  #142 扩散 LLMs 能通过离散扩散强迫实现比自回归更快的推理

**Authors**: [Xu Wang](https://arxiv.org/search/?searchtype=author&query=Xu Wang), [Chenkai Xu](https://arxiv.org/search/?searchtype=author&query=Chenkai Xu), [Yijie Jin](https://arxiv.org/search/?searchtype=author&query=Yijie Jin), [Jiachun Jin](https://arxiv.org/search/?searchtype=author&query=Jiachun Jin), [Hao Zhang](https://arxiv.org/search/?searchtype=author&query=Hao Zhang), [Zhijie Deng](https://arxiv.org/search/?searchtype=author&query=Zhijie Deng)
...
**Publish**: 2025-08-08 04:51:37 UTC
发布：2025-08-08 04:51:37 UTC

## [#143](https://arxiv.org/abs/2508.09191) [From Values to Tokens: An LLM-Driven Framework for Context-aware Time Series Forecasting via Symbolic Discretization](https://papers.cool/arxiv/2508.09191)  #143 从数值到符号：一种由 LLM 驱动的通过符号离散实现上下文感知时间序列预测的框架

**Authors**: [Xiaoyu Tao](https://arxiv.org/search/?searchtype=author&query=Xiaoyu Tao), [Shilong Zhang](https://arxiv.org/search/?searchtype=author&query=Shilong Zhang), [Mingyue Cheng](https://arxiv.org/search/?searchtype=author&query=Mingyue Cheng), [Daoyu Wang](https://arxiv.org/search/?searchtype=author&query=Daoyu Wang), [Tingyue Pan](https://arxiv.org/search/?searchtype=author&query=Tingyue Pan), [Bokai Pan](https://arxiv.org/search/?searchtype=author&query=Bokai Pan), [Changqing Zhang](https://arxiv.org/search/?searchtype=author&query=Changqing Zhang), [Shijin Wang](https://arxiv.org/search/?searchtype=author&query=Shijin Wang)
作者：陶晓宇，张世龙，程明岳，王道宇，潘亭月，潘博凯，张长青，王世金
...
**Publish**: 2025-08-08 03:20:25 UTC
发布：2025-08-08 03:20:25 UTC

## [#145](https://arxiv.org/abs/2508.09189) [Hybrid(Transformer+CNN)-based Polyp Segmentation](https://papers.cool/arxiv/2508.09189)  #145 基于混合（Transformer+CNN）的息肉分割
...
**Publish**: 2025-08-08 01:42:05 UTC
发布时间：2025-08-08 01:42:05 UTC

## [#146](https://arxiv.org/abs/2508.09186) [RL-MoE: An Image-Based Privacy Preserving Approach In Intelligent Transportation System](https://papers.cool/arxiv/2508.09186)  #146 RL-MoE：一种用于智能交通系统的基于图像的隐私保护方法

**Authors**: [Abdolazim Rezaei](https://arxiv.org/search/?searchtype=author&query=Abdolazim Rezaei), [Mehdi Sookhak](https://arxiv.org/search/?searchtype=author&query=Mehdi Sookhak), [Mahboobeh Haghparast](https://arxiv.org/search/?searchtype=author&query=Mahboobeh Haghparast)
...
**Publish**: 2025-08-07 18:07:54 UTC
发布：2025-08-07 18:07:54 UTC

## [#147](https://arxiv.org/abs/2508.09185) [A Neurosymbolic Framework for Interpretable Cognitive Attack Detection in Augmented Reality](https://papers.cool/arxiv/2508.09185)  #147 一个用于在增强现实中可解释认知攻击检测的神经符号框架

**Authors**: [Rongqian Chen](https://arxiv.org/search/?searchtype=author&query=Rongqian Chen), [Allison Andreyev](https://arxiv.org/search/?searchtype=author&query=Allison Andreyev), [Yanming Xiu](https://arxiv.org/search/?searchtype=author&query=Yanming Xiu), [Mahdi Imani](https://arxiv.org/search/?searchtype=author&query=Mahdi Imani), [Bin Li](https://arxiv.org/search/?searchtype=author&query=Bin Li), [Maria Gorlatova](https://arxiv.org/search/?searchtype=author&query=Maria Gorlatova), [Gang Tan](https://arxiv.org/search/?searchtype=author&query=Gang Tan), [Tian Lan](https://arxiv.org/search/?searchtype=author&query=Tian Lan)
作者：陈荣谦、Allison Andreyev、肖炎明、Mahdi Imani、李斌、Maria Gorlatova、谭刚、兰天
...
**Publish**: 2025-08-07 17:59:49 UTC
发表时间：2025-08-07 17:59:49 UTC

## [#148](https://arxiv.org/abs/2508.09184) [HiSTM: Hierarchical Spatiotemporal Mamba for Cellular Traffic Forecasting](https://papers.cool/arxiv/2508.09184)  #148 HiSTM：用于蜂窝流量预测的分层时空曼巴模型
...
**Publish**: 2025-08-07 14:18:18 UTC
发布：2025-08-07 14:18:18 UTC

## [#149](https://arxiv.org/abs/2508.09183) [Quantum-Efficient Reinforcement Learning Solutions for Last-Mile On-Demand Delivery](https://papers.cool/arxiv/2508.09183)  #149 面向最后一公里按需配送的量子高效强化学习解决方案

**Authors**: [Farzan Moosavi](https://arxiv.org/search/?searchtype=author&query=Farzan Moosavi), [Bilal Farooq](https://arxiv.org/search/?searchtype=author&query=Bilal Farooq)
...
量子计算已展示出解决 NP 难组合问题的有前景替代方案。具体而言，在优化问题上，传统方法在处理大规模解时变得难以应对。本文特别探讨利用量子计算来解决带时间窗的带容量取送货问题（CPDPTW）的大规模实例。为此，设计了一个用参数化量子电路（PQC）增强的强化学习（RL）框架，以最小化现实最后一公里按需配送中的行驶时间。提出了一种具有纠缠层和变分层的新型问题专用编码量子电路。此外，通过数值实验设计了近端策略优化（PPO）和量子奇异值变换（QSVT）作为对比，强调了所提方法在解的规模和训练复杂度方面的优越性，同时纳入了现实世界的约束。

**Subjects**: [Quantum Physics](https://papers.cool/arxiv/quant-ph), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Machine Learning](https://papers.cool/arxiv/cs.LG), [Optimization and Control](https://papers.cool/arxiv/math.OC)
主题：量子物理、人工智能、机器学习、优化与控制

**Publish**: 2025-08-07 13:50:43 UTC
发布时间：2025-08-07 13:50:43 UTC

## [#150](https://arxiv.org/abs/2508.09181) [Long-Term Client Selection for Federated Learning with Non-IID Data: A Truthful Auction Approach](https://papers.cool/arxiv/2508.09181)  #150 长期客户端选择用于非独立同分布数据的联邦学习：一种诚实的拍卖方法

**Authors**: [Jinghong Tan](https://arxiv.org/search/?searchtype=author&query=Jinghong Tan), [Zhian Liu](https://arxiv.org/search/?searchtype=author&query=Zhian Liu), [Kun Guo](https://arxiv.org/search/?searchtype=author&query=Kun Guo), [Mingxiong Zhao](https://arxiv.org/search/?searchtype=author&query=Mingxiong Zhao)
作者：谭靖宏，刘志安，郭昆，赵明雄
...
**Publish**: 2025-08-07 12:30:52 UTC
发布：2025-08-07 12:30:52 UTC

## [#151](https://arxiv.org/abs/2508.09180) [scAGC: Learning Adaptive Cell Graphs with Contrastive Guidance for Single-Cell Clustering](https://papers.cool/arxiv/2508.09180)  #151 scAGC：使用对比引导学习自适应细胞图以进行单细胞聚类 [PDF ] [Copy] [Kimi 2 ] [REL]

**Authors**: [Huifa Li](https://arxiv.org/search/?searchtype=author&query=Huifa Li), [Jie Fu](https://arxiv.org/search/?searchtype=author&query=Jie Fu), [Xinlin Zhuang](https://arxiv.org/search/?searchtype=author&query=Xinlin Zhuang), [Haolin Yang](https://arxiv.org/search/?searchtype=author&query=Haolin Yang), [Xinpeng Ling](https://arxiv.org/search/?searchtype=author&query=Xinpeng Ling), [Tong Cheng](https://arxiv.org/search/?searchtype=author&query=Tong Cheng), [Haochen xue](https://arxiv.org/search/?searchtype=author&query=Haochen xue), [Imran Razzak](https://arxiv.org/search/?searchtype=author&query=Imran Razzak), [Zhili Chen](https://arxiv.org/search/?searchtype=author&query=Zhili Chen)
作者：李惠发、傅杰、庄新林、杨浩林、凌新鹏、程通、薛浩晨、Imran Razzak、陈志立
...
**Publish**: 2025-08-07 01:13:46 UTC
发布时间：2025-08-07 01:13:46 协调世界时 (UTC)

## [#157](https://arxiv.org/abs/2508.09171) [webMCP: Efficient AI-Native Client-Side Interaction for Agent-Ready Web Design](https://papers.cool/arxiv/2508.09171)  #157 webMCP：面向代理就绪网页设计的高效原生客户端 AI 交互
...
**Publish**: 2025-08-06 23:02:36 UTC
发布：2025-08-06 23:02:36 UTC

## [#158](https://arxiv.org/abs/2508.09170) [Multimodal RAG Enhanced Visual Description](https://papers.cool/arxiv/2508.09170)  #158 多模态 RAG 增强视觉描述

**Authors**: [Amit Kumar Jaiswal](https://arxiv.org/search/?searchtype=author&query=Amit Kumar Jaiswal), [Haiming Liu](https://arxiv.org/search/?searchtype=author&query=Haiming Liu), [Ingo Frommholz](https://arxiv.org/search/?searchtype=author&query=Ingo Frommholz)
...
**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Computer Vision and Pattern Recognition](https://papers.cool/arxiv/cs.CV), [Information Retrieval](https://papers.cool/arxiv/cs.IR)
主题：机器学习、人工智能、计算机视觉与模式识别、信息检索

**Publish**: 2025-08-06 19:04:38 UTC
发布：2025-08-06 19:04:38 UTC

## [#159](https://arxiv.org/abs/2508.09163) [Energy-Efficient Stochastic Computing (SC) Neural Networks for Internet of Things Devices With Layer-Wise Adjustable Sequence Length (ASL)](https://papers.cool/arxiv/2508.09163)  #159 面向物联网设备的节能随机计算（SC）神经网络，具有逐层可调序列长度（ASL）

**Authors**: [Ziheng Wang](https://arxiv.org/search/?searchtype=author&query=Ziheng Wang), [Pedro Reviriego](https://arxiv.org/search/?searchtype=author&query=Pedro Reviriego), [Farzad Niknia](https://arxiv.org/search/?searchtype=author&query=Farzad Niknia), [Zhen Gao](https://arxiv.org/search/?searchtype=author&query=Zhen Gao), [Javier Conde](https://arxiv.org/search/?searchtype=author&query=Javier Conde), [Shanshan Liu](https://arxiv.org/search/?searchtype=author&query=Shanshan Liu), [Fabrizio Lombardi](https://arxiv.org/search/?searchtype=author&query=Fabrizio Lombardi)
...
**Publish**: 2025-08-05 16:45:24 UTC
发布：2025-08-05 16:45:24 UTC

## [#160](https://arxiv.org/abs/2508.09161) [Physics-Guided Memory Network for Building Energy Modeling](https://papers.cool/arxiv/2508.09161)  #160 基于物理引导的记忆网络用于建筑能耗建模
...
**Publish**: 2025-08-05 15:16:19 UTC
发布时间：2025-08-05 15:16:19 协调世界时 (UTC)

## [#161](https://arxiv.org/abs/2508.09159) [Agoran: An Agentic Open Marketplace for 6G RAN Automation](https://papers.cool/arxiv/2508.09159)  #161 Agoran：一个用于 6G RAN 自动化的智能开放市场

**Authors**: [Ilias Chatzistefanidis](https://arxiv.org/search/?searchtype=author&query=Ilias Chatzistefanidis), [Navid Nikaein](https://arxiv.org/search/?searchtype=author&query=Navid Nikaein), [Andrea Leone](https://arxiv.org/search/?searchtype=author&query=Andrea Leone), [Ali Maatouk](https://arxiv.org/search/?searchtype=author&query=Ali Maatouk), [Leandros Tassioulas](https://arxiv.org/search/?searchtype=author&query=Leandros Tassioulas), [Roberto Morabito](https://arxiv.org/search/?searchtype=author&query=Roberto Morabito), [Ioannis Pitsiorlas](https://arxiv.org/search/?searchtype=author&query=Ioannis Pitsiorlas), [Marios Kountouris](https://arxiv.org/search/?searchtype=author&query=Marios Kountouris)
...
**Publish**: 2025-08-05 12:17:03 UTC
发布：2025-08-05 12:17:03 世界协调时间（UTC）

## [#162](https://arxiv.org/abs/2508.09158) [EvaDrive: Evolutionary Adversarial Policy Optimization for End-to-End Autonomous Driving](https://papers.cool/arxiv/2508.09158)  #162 EvaDrive：用于端到端自动驾驶的进化对抗策略优化

**Authors**: [Siwen Jiao](https://arxiv.org/search/?searchtype=author&query=Siwen Jiao), [Kangan Qian](https://arxiv.org/search/?searchtype=author&query=Kangan Qian), [Hao Ye](https://arxiv.org/search/?searchtype=author&query=Hao Ye), [Yang Zhong](https://arxiv.org/search/?searchtype=author&query=Yang Zhong), [Ziang Luo](https://arxiv.org/search/?searchtype=author&query=Ziang Luo), [Sicong Jiang](https://arxiv.org/search/?searchtype=author&query=Sicong Jiang), [Zilin Huang](https://arxiv.org/search/?searchtype=author&query=Zilin Huang), [Yangyi Fang](https://arxiv.org/search/?searchtype=author&query=Yangyi Fang), [Jinyu Miao](https://arxiv.org/search/?searchtype=author&query=Jinyu Miao), [Zheng Fu](https://arxiv.org/search/?searchtype=author&query=Zheng Fu), [Yunlong Wang](https://arxiv.org/search/?searchtype=author&query=Yunlong Wang), [Kun Jiang](https://arxiv.org/search/?searchtype=author&query=Kun Jiang), [Diange Yang](https://arxiv.org/search/?searchtype=author&query=Diange Yang), [Rui Fan](https://arxiv.org/search/?searchtype=author&query=Rui Fan), [Baoyun Peng](https://arxiv.org/search/?searchtype=author&query=Baoyun Peng)
作者：焦思文、钱康安、叶昊、钟扬、罗子昂、蒋思聪、黄子林、方阳义、缪金玉、付正、王云龙、姜坤、杨殿阁、范睿、彭宝云
...
**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Applications](https://papers.cool/arxiv/stat.AP)
主题：机器学习，人工智能，应用

**Publish**: 2025-08-05 09:32:04 UTC
发布：2025-08-05 09:32:04 UTC

## [#164](https://arxiv.org/abs/2508.09155) [A Rolling Stone Gathers No Moss: Adaptive Policy Optimization for Stable Self-Evaluation in Large Multimodal Models](https://papers.cool/arxiv/2508.09155)  #164 一滚石不生苔：用于大型多模态模型稳定自我评估的自适应策略优化 [PDF ] [复制] [Kimi ] [关系]

**Authors**: [Wenkai Wang](https://arxiv.org/search/?searchtype=author&query=Wenkai Wang), [Hongcan Guo](https://arxiv.org/search/?searchtype=author&query=Hongcan Guo), [Zheqi Lv](https://arxiv.org/search/?searchtype=author&query=Zheqi Lv), [Shengyu Zhang](https://arxiv.org/search/?searchtype=author&query=Shengyu Zhang)
作者：王文凯、郭宏灿、吕哲琪、张胜宇
...
**Publish**: 2025-08-05 07:54:01 UTC
发布：2025-08-05 07:54:01 UTC

## [#165](https://arxiv.org/abs/2508.09154) [Peer Effect Estimation in the Presence of Simultaneous Feedback and Unobserved Confounders](https://papers.cool/arxiv/2508.09154)  #165 同时存在反馈与未观测混杂因素下的同伴效应估计

**Authors**: [Xiaojing Du](https://arxiv.org/search/?searchtype=author&query=Xiaojing Du), [Jiuyong Li](https://arxiv.org/search/?searchtype=author&query=Jiuyong Li), [Lin Liu](https://arxiv.org/search/?searchtype=author&query=Lin Liu), [Debo Cheng](https://arxiv.org/search/?searchtype=author&query=Debo Cheng), [Thuc. Le](https://arxiv.org/search/?searchtype=author&query=Thuc. Le)
作者：杜晓静、李九永、刘琳、程德波、黎叔。
...
**Subjects**: [Machine Learning](https://papers.cool/arxiv/cs.LG), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Methodology](https://papers.cool/arxiv/stat.ME)
主题：机器学习、人工智能、方法论

**Publish**: 2025-08-05 05:49:49 UTC
发布日期：2025-08-05 05:49:49 UTC

## [#166](https://arxiv.org/abs/2508.09153) [JustDense: Just using Dense instead of Sequence Mixer for Time Series analysis](https://papers.cool/arxiv/2508.09153)  #166 JustDense：仅使用 Dense 替代 Sequence Mixer 进行时间序列分析

**Authors**: [TaekHyun Park](https://arxiv.org/search/?searchtype=author&query=TaekHyun Park), [Yongjae Lee](https://arxiv.org/search/?searchtype=author&query=Yongjae Lee), [Daesan Park](https://arxiv.org/search/?searchtype=author&query=Daesan Park), [Dohee Kim](https://arxiv.org/search/?searchtype=author&query=Dohee Kim), [Hyerim Bae](https://arxiv.org/search/?searchtype=author&query=Hyerim Bae)
...
**Publish**: 2025-08-04 15:49:09 UTC
发布：2025-08-04 15:49:09 UTC

## [#167](https://arxiv.org/abs/2508.09152) [5G Core Fault Detection and Root Cause Analysis using Machine Learning and Generative AI](https://papers.cool/arxiv/2508.09152)  #167 5G 核心网故障检测与根因分析，使用机器学习与生成式人工智能

**Authors**: [Joseph H. R. Isaac](https://arxiv.org/search/?searchtype=author&query=Joseph H. R. Isaac), [Harish Saradagam](https://arxiv.org/search/?searchtype=author&query=Harish Saradagam), [Nallamothu Pardhasaradhi](https://arxiv.org/search/?searchtype=author&query=Nallamothu Pardhasaradhi)
...
**Publish**: 2025-08-04 05:20:32 UTC
发布：2025-08-04 05:20:32 UTC

## [#168](https://arxiv.org/abs/2508.09148) [Motif 2.6B Technical Report](https://papers.cool/arxiv/2508.09148)  #168 Motif 2.6B 技术报告

**Authors**: [Junghwan Lim](https://arxiv.org/search/?searchtype=author&query=Junghwan Lim), [Sungmin Lee](https://arxiv.org/search/?searchtype=author&query=Sungmin Lee), [Dongseok Kim](https://arxiv.org/search/?searchtype=author&query=Dongseok Kim), [Eunhwan Park](https://arxiv.org/search/?searchtype=author&query=Eunhwan Park), [Hyunbyung Park](https://arxiv.org/search/?searchtype=author&query=Hyunbyung Park), [Junhyeok Lee](https://arxiv.org/search/?searchtype=author&query=Junhyeok Lee), [Wai Ting Cheung](https://arxiv.org/search/?searchtype=author&query=Wai Ting Cheung), [Dahye Choi](https://arxiv.org/search/?searchtype=author&query=Dahye Choi), [Jaeheui Her](https://arxiv.org/search/?searchtype=author&query=Jaeheui Her), [Jaeyeon Huh](https://arxiv.org/search/?searchtype=author&query=Jaeyeon Huh), [Hanbin Jung](https://arxiv.org/search/?searchtype=author&query=Hanbin Jung), [Changjin Kang](https://arxiv.org/search/?searchtype=author&query=Changjin Kang), [Beomgyu Kim](https://arxiv.org/search/?searchtype=author&query=Beomgyu Kim), [Jihwan Kim](https://arxiv.org/search/?searchtype=author&query=Jihwan Kim), [Minjae Kim](https://arxiv.org/search/?searchtype=author&query=Minjae Kim), [Taehwan Kim](https://arxiv.org/search/?searchtype=author&query=Taehwan Kim), [Youngrok Kim](https://arxiv.org/search/?searchtype=author&query=Youngrok Kim), [Haesol Lee](https://arxiv.org/search/?searchtype=author&query=Haesol Lee), [Jeesoo Lee](https://arxiv.org/search/?searchtype=author&query=Jeesoo Lee), [Kungyu Lee](https://arxiv.org/search/?searchtype=author&query=Kungyu Lee), [Dongpin Oh](https://arxiv.org/search/?searchtype=author&query=Dongpin Oh), [Yeongjae Park](https://arxiv.org/search/?searchtype=author&query=Yeongjae Park), [Bokki Ryu](https://arxiv.org/search/?searchtype=author&query=Bokki Ryu), [Daewon Suh](https://arxiv.org/search/?searchtype=author&query=Daewon Suh), [Dongjoo Weon](https://arxiv.org/search/?searchtype=author&query=Dongjoo Weon)
...
随着 6G 网络向日益以 AI 驱动、以用户为中心的生态系统演进，传统的被动切换机制展现出局限性，尤其在移动边缘计算和基于自主代理的服务场景中。本文提出了 WAAN，一种跨层框架，通过将轻量级 TinyML 代理作为能够自主协商的实体嵌入到异构边缘节点中，实现了意图感知和前瞻性切换，这些节点有助于意图传播和网络自适应。为确保在移动导致的中断中保持连续性，WAAN 引入了半稳定会合点，作为上下文传输和状态保存的协调锚点。通过一个多模态环境控制的案例研究展示了该框架的运行能力，突出了其在移动情况下保持用户体验的有效性。最后，文章讨论了与 WAAN 部署和演进相关的关键挑战和未来机会。

**Subjects**: [Networking and Internet Architecture](https://papers.cool/arxiv/cs.NI), [Artificial Intelligence](https://papers.cool/arxiv/cs.AI), [Distributed, Parallel, and Cluster Computing](https://papers.cool/arxiv/cs.DC), [Machine Learning](https://papers.cool/arxiv/cs.LG), [Multiagent Systems](https://papers.cool/arxiv/cs.MA)
主题：网络与互联网架构、人工智能、分布式、并行与集群计算、机器学习、多智能体系统

**Publish**: 2025-08-02 06:13:42 UTC
发布时间：2025-08-02 06:13:42 协调世界时 (UTC)

## [#170](https://arxiv.org/abs/2508.09146) [To Theoretically Understand Transformer-Based In-Context Learning for Optimizing CSMA](https://papers.cool/arxiv/2508.09146)  #170 理论上理解基于 Transformer 的上下文学习在优化 CSMA 中的应用

**Authors**: [Shugang Hao](https://arxiv.org/search/?searchtype=author&query=Shugang Hao), [Hongbo Li](https://arxiv.org/search/?searchtype=author&query=Hongbo Li), [Lingjie Duan](https://arxiv.org/search/?searchtype=author&query=Lingjie Duan)
作者：郝树刚、李鸿博、段凌杰
...
**Publish**: 2025-07-31 23:31:23 UTC
发布：2025-07-31 23:31:23 UTC

## [#171](https://arxiv.org/abs/2508.09144) [Efficient Real-Time Aircraft ETA Prediction via Feature Tokenization Transformer](https://papers.cool/arxiv/2508.09144)  #171 高效实时飞机预计到达时间预测：基于特征标记化的 Transformer
...
**Publish**: 2025-07-29 03:32:01 UTC
出版：2025-07-29 03:32:01 UTC

## [#173](https://arxiv.org/abs/2508.05884) [User-Intent-Driven Semantic Communication via Adaptive Deep Understanding](https://papers.cool/arxiv/2508.05884)  #173 基于用户意图驱动的语义通信：通过自适应深度理解

**Authors**: [Peigen Ye](https://arxiv.org/search/?searchtype=author&query=Peigen Ye), [Jingpu Duan](https://arxiv.org/search/?searchtype=author&query=Jingpu Duan), [Hongyang Du](https://arxiv.org/search/?searchtype=author&query=Hongyang Du), [Yulan Guo](https://arxiv.org/search/?searchtype=author&query=Yulan Guo)
作者：叶培根，段静璞，杜洪洋，郭玉兰
...
语义通信侧重于传输与任务相关的语义信息，旨在实现以意图为导向的通信。尽管现有系统通过提取关键语义提高了效率，但仍未能深入理解并泛化用户的真实意图。为此，我们提出了一种用户意图驱动的语义通信系统，以解释多样的抽象意图。首先，我们将多模态大模型作为语义知识库以生成用户意图先验。接着，提出了一个掩码引导注意力模块，有效突出关键语义区域。进一步地，通道状态感知模块确保在不同信道条件下的自适应、鲁棒传输。大量实验表明，我们的系统实现了深层意图理解并优于 DeepJSCC，例如在 Rayleigh 信道、5 dB SNR 下，PSNR、SSIM 和 LPIPS 分别提升了 8%、6%和 19%。

**Subject**: [Information Theory](https://papers.cool/arxiv/cs.IT)
主题：信息论

**Publish**: 2025-08-07 22:26:27 UTC
发布：2025-08-07 22:26:27 协调世界时

## [#174](https://arxiv.org/abs/2504.19716) [QuickGrasp: Lightweight Antipodal Grasp Planning with Point Clouds](https://papers.cool/arxiv/2504.19716)  #174 QuickGrasp：基于点云的轻量级对捏抓取规划

**Authors**: [Navin Sriram Ravie](https://arxiv.org/search/?searchtype=author&query=Navin Sriram Ravie), [Keerthi Vasan M](https://arxiv.org/search/?searchtype=author&query=Keerthi Vasan M), [Asokan Thondiyath](https://arxiv.org/search/?searchtype=author&query=Asokan Thondiyath), [Bijo Sebastian](https://arxiv.org/search/?searchtype=author&query=Bijo Sebastian)
...
**Subject**: [Robotics](https://papers.cool/arxiv/cs.RO) 主题：机器人学

**Publish**: 2025-04-28 12:09:10 UTC
发布：2025-04-28 12:09:10 UTC

# 1.3 Huggingface

- [WebWatcher：突破视觉语言深度研究代理的新前沿（80▲） ](https://huggingface.co/papers/2508.05748?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [超越十回合：用大规模异步RL解锁长视界代理搜索（33▲） ](https://huggingface.co/papers/2508.07976?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [人物镜头：可控一致的4D人物动画（28▲） ](https://huggingface.co/papers/2508.07409?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [时间是一个特征：利用扩散语言模型中的时间动态（26▲） ](https://huggingface.co/papers/2508.09138?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [Matrix-3D：全方位可探索的3D世界生成（24▲） ](https://huggingface.co/papers/2508.08086?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [HierSearch：集成本地和Web搜索的分层企业深度搜索框架（23▲） ](https://huggingface.co/papers/2508.08088?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [复杂逻辑指令生成（16▲） ](https://huggingface.co/papers/2508.09125?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [VertexRegen：具有连续细节级别的网格生成（15▲） ](https://huggingface.co/papers/2508.09062?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [Aryabhata：面向考试的JEE数学语言模型（12▲） ](https://huggingface.co/papers/2508.08665?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [基于区域一致性的GUI接地测试时间强化学习（12▲） ](https://huggingface.co/papers/2508.05615?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [UNCAGE：文本到图像生成中掩膜生成变形的对比注意引导（12▲） ](https://huggingface.co/papers/2508.05399?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [长训练，短思考：高效推理的课程学习（11） ](https://huggingface.co/papers/2508.08940?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
- [还有23篇论文](https://huggingface.co/papers?utm_source=digest-papers&utm_medium=email&utm_campaign=2025-08-13)
...
3. [qwen3-VL 来了](https://mp.weixin.qq.com/s/6tSbEwrN4Hu5iBIol0mpjw)
4. Meditron
...
1. [混合数学编程逻辑数据，一次性提升AI多领域强化学习能力 | 上海AI Lab](https://mp.weixin.qq.com/s/pXKpvJ-PWV2DXMywyJO4jA)

   1. 现有关于强化学习和模型的研究多聚焦于单一领域优化，缺乏对跨领域知识迁移和协同推理能力的系统性探索，让模型能够在多领域协同工作，发挥更好的推理能力。
   2. 团队构建了一个涵盖数学（Math）、编程（Code）和逻辑谜题（Puzzle）三大类数据的**多领域评估框架**，并为不同训练数据设计了**定制化的奖励策略。**
   3. **Puzzle与Math数据的相互支持**：逻辑推理与数学能力相辅相成，显著提升模型的整体性能。
   4. 论文地址：https://arxiv.org/abs/2507.17512
      训练代码：https://github.com/Leey21/A-Data-Centric-Study
2. 少思考多采样：用于简洁推理的分组过滤策略优化

[#21](https://arxiv.org/abs/2508.09726) [Sample More to Think Less: Group Filtered Policy Optimization for Concise Reasoning](https://papers.cool/arxiv/2508.09726) [少思考多采样：用于简洁推理的分组过滤策略优化](https://papers.cool/arxiv/2508.09726)

使用可验证奖励进行强化学习训练的大型语言模型往往以准确性换取长度——通过增加回答长度来取得准确性提升。虽然对于更难的问题更长的答案可能是合理的，但许多标记只是“填充物”：重复、冗长的文本并没有真正推进解答。我们提出了 GFPO（组过滤策略优化），通过在训练时对每个问题采样更大的组并基于两个关键指标筛选用于训练的回应来遏制这种长度膨胀： (1) 回答长度和 (2) 标记效率：每标记奖励比率。通过在训练时进行更多采样，我们教会模型在推理时少思考。在 Phi-4-reasoning 模型上，GFPO 在保持准确性的同时，将 GRPO 在具有挑战性的 STEM 和编码基准（AIME 24/25、GPQA、Omni-MATH、LiveCodeBench）上的长度膨胀减少了 46–71%。以每标记奖励进行优化则进一步将长度膨胀减少到 71–85%。 我们还提出了自适应难度 GFPO，它根据实时难度估计为更难的问题动态分配更多训练资源，从而在计算效率与准确性之间取得更好的平衡，尤其是在困难问题上。GFPO 证明了增加训练阶段的计算量可以直接转化为测试阶段计算量的减少——这是实现高效推理的一种简单而有效的权衡。

发布：2025-08-13 11:43:49 UTC

3. 大型语言模型在数学计算与推理中的错误

[#1](https://arxiv.org/abs/2508.09932) [Mathematical Computation and Reasoning Errors by Large Language Models](https://papers.cool/arxiv/2508.09932)
...
4. [链式思维是幻象吗？从数据分布视角重新审视大模型推理，马斯克回复，Grok破防](https://mp.weixin.qq.com/s/3uTM1Fu-B-QWjfy0FkpE3A)
6. [DeepMind AlphaProof 前负责人谈2025年IMO](https://mp.weixin.qq.com/s/CVRU8-oYJu-Mu4RrFqefMA)
...
1. EffiEval：通过能力覆盖最大化实现高效且具可泛化性的模型评估
...
1. [破解「长程智能体」RL训练难题，腾讯提出RLVMR框架，让7B模型「思考」比肩GPT-4o](https://mp.weixin.qq.com/s/KICyG1BKoDP7pvFZGRrL1A)
2. AWorld：用于鲁棒 GAIA 问题求解的具稳定机动性的动态多智能体系统

[#3](https://arxiv.org/abs/2508.09889) [AWorld: Dynamic Multi-Agent System with Stable Maneuvering for Robust GAIA Problem Solving](https://papers.cool/arxiv/2508.09889) 
...
[LeetCode刷够100小时，学会找人内推，OpenAI员工下场教你拿Offer](https://mp.weixin.qq.com/s/7vCl4nwPLeBk9KWQ1oMinQ)
