...
[[items]]
id = "agent-solver-20-2"
title = "阿里巴巴与上交等提出 Agent 自进化方法，Solver 性能提升 20.2 个百分点"
subtopic = "自进化"
topics = [
    "逻辑推理",
    "智能体",
...
research = []
source = "微信公众号"
summary = "阿里巴巴、上海交通大学等单位开展 Agent 自进化研究，使 Solver 性能提升 20.2 个百分点。"
paper = ""
code = ""
dataset = ""
link = "https://mp.weixin.qq.com/s/X9Q7v85-uuca1R7tOCouZw"
content = "阿里巴巴与上海交通大学等单位提出了一项面向 Agent 的自进化工作。该方法旨在通过自主迭代提升智能体的逻辑推理与问题求解能力。实验结果显示，Solver 性能取得了 20.2 个百分点的提升，具有较显著的效果。该工作可作为智能体自我改进与推理能力增强方向的论文参考。"
purpose = "- 为 Agent 自进化和自主能力提升研究提供方法参考\n- 展示自进化机制对 Solver 推理性能的显著增益\n- 可用于相关论文的背景梳理、方法对比与实验设计"
