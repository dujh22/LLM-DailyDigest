...
[[items]]
id = "m-memoryllm"
title = "M+：以协同检索器扩展 MemoryLLM 的可扩展长期记忆"
subtopic = "长期记忆"
topics = [
    "智能体记忆",
    "智能体",
...
research = []
source = "公众号「人大高瓴-华为诺亚」"
summary = "M+ 通过协同检索机制扩展 MemoryLLM，使大语言模型能够更高效地管理和调用可扩展的长期记忆。"
paper = "https://arxiv.org/abs/2502.00592"
code = "https://github.com/wangyu-ustc/MemoryLLM"
dataset = ""
link = "https://mp.weixin.qq.com/s/n_oc7X1cZ1vGwPWhXpLUjA"
content = "M+ 是一项发表于 ICML 2025 的长期记忆研究，旨在提升 MemoryLLM 的记忆容量与扩展能力。其核心是引入协同检索器，从大规模长期记忆中选择与当前任务相关的信息，并与模型内部记忆机制配合。该方法面向持续交互和知识累积场景，帮助模型在记忆规模增长时保持有效调用能力。项目提供论文、官方代码以及 Hugging Face 开源模型。"
purpose = "- 为大语言模型和智能体构建可扩展的长期记忆机制\n- 通过协同检索降低大规模记忆调用的成本与噪声\n- 支持持续学习、长期对话和个性化智能体等应用\n- 可结合官方代码与开源模型复现并评估长期记忆方案"
notes = ""


[[items]]
id = "memory-agent"
title = "Memory+Agent：人大高瓴与华为诺亚构建大模型智能体记忆研究体系"
subtopic = "智能体记忆"
topics = [
    "智能体记忆",
    "智能体",
...
research = []
source = "未知"
summary = "人大高瓴人工智能学院与华为诺亚方舟实验室围绕大语言模型智能体的记忆能力，构建了涵盖综述、数据集与工具包的完整研究体系。"
paper = ""
code = ""
dataset = ""
link = ""
content = "中国人民大学高瓴人工智能学院与华为诺亚方舟实验室聚焦大语言模型智能体的记忆能力。双方围绕该方向形成了由综述论文、数据集和工具包组成的系统性研究体系。相关成果覆盖知识梳理、实验数据支持与研发工具建设，有助于推动智能体记忆技术的研究与落地。"
purpose = "- 为智能体记忆领域提供系统化的研究入口与知识框架\n- 通过数据集支持记忆能力的训练和标准化评估\n- 借助工具包降低记忆模块开发、验证与应用的门槛"
notes = ""
