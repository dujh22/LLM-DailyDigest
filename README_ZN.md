...
7. 新增每日可以自动执行程序
8. 优化arx.py中代码链接获取函数
9. 优化arx.py中代码星星数量获取函数
10. 优化tools/arx_batch_to_ch.py中的翻译准确性
11. 支持tools/arx_batch_to_ch.py中支持ACM分类，比如I.2.7 之类的，详见https://arxiv.org/category_taxonomy
...
* 优化arxiv完成构建pipeline：
  ...
  10. 连接arxiv下载流程和汉化生成日报流程+上传github项目中+每日后台自动执行 49min
